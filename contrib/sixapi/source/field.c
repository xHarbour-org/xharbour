...
HB_FUNC( SX_FIELDDECIMALS )
{
   ...
   if( ISCHAR( 1 ) )
      ...
      hb_retni( sx_FieldDecimals( ( PBYTE ) ( LONG_PTR ) SX_CONVFUNC( sx_FieldName( ( WORD ) hb_parni( 1 ) ) ) ) );
   else
      hb_retni( -1 );
...
HB_FUNC( SX_FIELDNAME )
{
   ...
   if( ISNUM( 1 ) )
      hb_retc( ( char * ) ( LONG_PTR ) SX_CONVFUNC( sx_FieldName( ( WORD ) hb_parni( 1 ) ) ) );
   else
      hb_retc( "" );
...
HB_FUNC( SX_FIELDTYPE )
{
   ...
   if( ISCHAR( 1 ) )
      hb_retc( ( char * ) ( LONG_PTR ) SX_CONVFUNC( sx_FieldType( ( PBYTE ) hb_parc( 1 ) ) ) );
   else if( ISNUM( 1 ) )
      hb_retc( ( char * ) ( LONG_PTR ) SX_CONVFUNC( sx_FieldType( ( PBYTE ) ( LONG_PTR ) SX_CONVFUNC( sx_FieldName( ( WORD ) hb_parni( 1 ) ) ) ) ) );
   else
      hb_retc( "" );
...
HB_FUNC( SX_FIELDWIDTH )
{
   ...
   if( ISCHAR( 1 ) )
      ...
      hb_retni( sx_FieldWidth( ( PBYTE ) ( LONG_PTR ) SX_CONVFUNC( sx_FieldName( ( WORD ) hb_parni( 1 ) ) ) ) );
   else
      hb_retni( -1 );
