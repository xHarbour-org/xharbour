...
HB_FUNC( SX_INDEXCONDITION )
{
   ...
   hb_retc( ( char * ) ( LONG_PTR ) SX_CONVFUNC( sx_IndexCondition() ) );
...
HB_FUNC( SX_INDEXKEY )
{
   ...
   hb_retc( ( char * ) ( LONG_PTR ) SX_CONVFUNC( sx_IndexKey() ) );
...
HB_FUNC( SX_INDEXKEYFIELD )
{
   ...
   hb_retc( ( char * ) ( LONG_PTR ) SX_CONVFUNC( sx_IndexKeyField() ) );
...
HB_FUNC( SX_INDEXNAME )
{
   ...
   if( ISNUM( 1 ) )
   {
      ...
      hb_retc( ( char * ) ( LONG_PTR ) SX_CONVFUNC( sx_IndexName( iIndex ) ) );
   }
   else
      hb_retc( "" );
...
HB_FUNC( SX_KEYDATA )
{
   ...
   hb_retc( ( char * ) ( LONG_PTR ) SX_CONVFUNC( sx_KeyData() ) );
...
HB_FUNC( SX_TAGINFO )
{
   ...
   if( _sx_Used() )
   {
      ...
      for( uiCount = uiIndex; uiCount <= nTagCount; uiCount++ )
      {
         sx_SetOrder( uiCount );
         hb_arrayNew( pItem, 8 );
         hb_arraySet( pItem, 1, hb_itemPutC( pData, ( char * ) ( LONG_PTR ) SX_CONVFUNC(sx_TagName( uiCount ) ) ) );
         hb_arraySet( pItem, 2, hb_itemPutC( pData, ( char * ) ( LONG_PTR ) SX_CONVFUNC(sx_IndexKey() ) ) );
         hb_arraySet( pItem, 3, hb_itemPutC( pData, ( char * ) ( LONG_PTR ) SX_CONVFUNC(sx_IndexCondition() ) ) );
         ...
         hb_arraySet( pItem, 7, hb_itemPutC( pData, ( char * ) ( LONG_PTR ) SX_CONVFUNC(sx_IndexName( uiCount ) ) ) );
         hb_arraySet( pItem, 8, hb_itemPutC( pData, ( char * ) ( LONG_PTR ) SX_CONVFUNC(sx_IndexKeyField() ) ) );
...
HB_FUNC( SX_TAGNAME )
{
   ...
   hb_retc( ( char * ) ( LONG_PTR ) SX_CONVFUNC(sx_TagName( ( WORD ) hb_parni( 1 ) ) /* iTagArea */ ) );
