 ...
 * File    : _wcstoull.c                                                    *
 *                                                                          *
 * Purpose : __wcstoull function [new C99].                                 *
 *                                                                          *
 * History : Date      Reason                                               *
 *           00-09-15  Created                                              *
 *           01-09-10  Rewritten.                                           *
...
#error LONG LONGS TOO LARGE FOR _WStoul
#endif
...
#if (ULLONG_MAX >> 16) >> 16 == 0xffffffff
...
unsigned long long __wcstoull(const wchar_t *s, wchar_t **endptr, int base)
{
    const wchar_t *sc, *sd;
    const wchar_t *s1, *s2;
    wchar_t sign;
