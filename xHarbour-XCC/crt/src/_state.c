 ...
 * File    : _state.c                                                       *
 *                                                                          *
 * Purpose : __[w]collatetab, __mbtowctab, and __wctombtab generic tables.  *
 *                                                                          *
 * History : Date      Reason                                               *
 *           00-09-15  Created                                              *
 *           01-09-05  Rewritten.                                           *
...
/*
 * Dinkumware: table not currently used, left as an example.
 * Pelle: everything works much better with this table! (едц in printf etc)
 */
...
extern char __mbcurmax = (WCHAR_MAX <= 0xff) ? 1 : (WCHAR_MAX <= 0xffff) ? 3 : 6;
#ifdef USETABLE
extern __fsmtab __collatetab = {{&tab0[1]}};    /* 0: 1-to-1 inline, &tab0[1]: 1-to-1 */
extern __fsmtab __wcollatetab = {{&tab0[1]}};   /* 0: 1-to-1 inline, &tab0[1]: 1-to-1 */
extern __fsmtab __mbtowctab = {{&tab0[1]}};     /* 0: UTF8, &tab0[1]: 1-to-1 */
extern __fsmtab __wctombtab = {{&tab0[1]}};     /* 0: UTF8, &tab0[1]: 1-to-1 */
#else /* USETABLE */
extern __fsmtab __collatetab = {{0}};   /* 0: 1-to-1 inline, &tab0[1]: 1-to-1 */
extern __fsmtab __wcollatetab = {{0}};  /* 0: 1-to-1 inline, &tab0[1]: 1-to-1 */
extern __fsmtab __mbtowctab = {{0}};    /* 0: UTF8, &tab0[1]: 1-to-1 */
extern __fsmtab __wctombtab = {{0}};    /* 0: UTF8, &tab0[1]: 1-to-1 */
#endif /* USETABLE */
