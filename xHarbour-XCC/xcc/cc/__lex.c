 ...
 * History : Date      Reason                                               *
 *           00-06-06  Created                                              *
 *           04-12-10  Use MultiByteToWideChar for wide string literals.    *
 *                                                                          *
 ****************************************************************************/
...
/* use MultiByteToWideChar for wide string literals? */
#define MBTOWC
...
id:
            ...
            case 'L':
                ...
                {
#ifdef MBTOWC
                    char *s = sconst(*cp, wcput, cbuf);
                    if (s - cbuf > 2)
                        apperror(RCWARNING1(ERROR_EXCESS_WIDE_CHAR));
                    else if (s - cbuf < 2)
                        apperror(RCERROR(ERROR_EMPTY_WIDE_CHAR));
                    MultiByteToWideChar(CP_ACP, 0, cbuf, (s - cbuf), wcbuf, NELEMS(wcbuf));
#else
            ...
            case '_':
                switch (*rcp)
                {
                    ...
                    case 'a':
                        /* also accept _asm, for backward compatibility */
                        if (rcp[0] == 'a' &&
                            rcp[1] == 's' &&
                            rcp[2] == 'm' &&
                            !(map[rcp[3]] & (DIGIT|LETTER)))
                    ...
                    case 'c':
                        /* also accept _cdecl, for backward compatibility */
                        if (rcp[0] == 'c' &&
                            rcp[1] == 'd' &&
                            rcp[2] == 'e' &&
                            rcp[3] == 'c' &&
                    ...
                    case 'd':
                        /* also accept _declspec, for backward compatibility */
                        if (rcp[0] == 'd' &&
                            rcp[1] == 'e' &&
                            rcp[2] == 'c' &&
                            rcp[3] == 'l' &&
                    ...
                    case 'f':
                        /* also accept _fastcall, for backward compatibility */
                        if (rcp[0] == 'f' &&
                            rcp[1] == 'a' &&
                            rcp[2] == 's' &&
                            rcp[3] == 't' &&
                    ...
                    case 'i':
                        /* also accept _inline, for backward compatibility */
                        if (rcp[0] == 'i' &&
                            rcp[1] == 'n' &&
                            rcp[2] == 'l' &&
                            rcp[3] == 'i' &&
                    ...
                    case 's':
                        /* also accept _stdcall, for backward compatibility */
                        if (rcp[0] == 's' &&
                            rcp[1] == 't' &&
                            rcp[2] == 'd' &&
                            rcp[3] == 'c' &&
