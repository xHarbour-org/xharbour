...
#else /* _WINCE */
#define getwc(str)  fgetwc(str)
#define putwc(c,str)  fputwc(c,str)
#endif /* _WINCE */
...
int __cdecl _snwprintf(wchar_t * restrict, size_t, const wchar_t * restrict, ...);
int __cdecl _vsnwprintf(wchar_t * restrict, size_t, const wchar_t * restrict, va_list);
...
#ifndef _WINCE
wchar_t * __cdecl _wcsdate(wchar_t *);
wchar_t * __cdecl _wcstime(wchar_t *);
int __cdecl _wmemicmp(const wchar_t *, const wchar_t *, size_t);
#endif /* _WINCE */
