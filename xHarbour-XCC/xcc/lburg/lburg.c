 ...
 * File    : lburg.c                                                        *
 *                                                                          *
 * Purpose : Ansi C Compiler; LBURG utility; Main module.                   *
 *                                                                          *
 * History : Date      Reason                                               *
 *           99-09-05  Created                                              *
 *                                                                          *
 ...
 * Function: alloc                                                          *
 *                                                                          *
 * Purpose : Allocate nbytes or issue fatal error.                          *
 *                                                                          *
 * History : Date      Reason                                               *
 *           99-09-05  Created                                              *
 *                                                                          *
 ...
 * Function: stringf                                                        *
 *                                                                          *
 * Purpose : Format and save a string.                                      *
 *                                                                          *
 * History : Date      Reason                                               *
 *           99-09-05  Created                                              *
 *                                                                          *
 ...
 * Function: hash                                                           *
 *                                                                          *
 * Purpose : Return hash number for str.                                    *
 *                                                                          *
 * History : Date      Reason                                               *
 *           99-09-05  Created                                              *
 *                                                                          *
 ...
 * Function: nonterm                                                        *
 *                                                                          *
 * Purpose : Create a new terminal id, if necessary.                        *
 *                                                                          *
 * History : Date      Reason                                               *
 *           99-09-05  Created                                              *
 *                                                                          *
 ...
 * Function: term                                                           *
 *                                                                          *
 * Purpose : Create a new terminal id with external symbol number esn.      *
 *                                                                          *
 * History : Date      Reason                                               *
 *           99-09-05  Created                                              *
 *                                                                          *
 ...
 * Function: tree                                                           *
 *                                                                          *
 * Purpose : Create & initialize a tree node with the given fields.         *
 *                                                                          *
 * History : Date      Reason                                               *
 *           99-09-05  Created                                              *
 *                                                                          *
 ...
 * Function: rule                                                           *
 *                                                                          *
 * Purpose : Create & initialize a rule with the given fields.              *
 *                                                                          *
 * History : Date      Reason                                               *
 *           99-09-05  Created                                              *
 *                                                                          *
 ...
 * Function: reach                                                          *
 *                                                                          *
 * Purpose : Mark all nonterminals in tree t as reachable.                  *
 *                                                                          *
 * History : Date      Reason                                               *
 *           99-09-05  Created                                              *
 *                                                                          *
 ...
 * Function: ckreach                                                        *
 *                                                                          *
 * Purpose : Mark all nonterminals reachable from p.                        *
 *                                                                          *
 * History : Date      Reason                                               *
 *           99-09-05  Created                                              *
 *                                                                          *
 ...
 * Function: emitcase                                                       *
 *                                                                          *
 * Purpose : Emit one case in function state.                               *
 *                                                                          *
 * History : Date      Reason                                               *
 *           99-09-05  Created                                              *
 *                                                                          *
 ...
 *                                                                          *
 * Purpose : Emit the closure functions.                                    *
 *                                                                          *
 * History : Date      Reason                                               *
 *           99-09-05  Created                                              *
 *                                                                          *
 ...
 * Function: emitcost                                                       *
 *                                                                          *
 * Purpose : Emit cost computation for tree t.                              *
 *                                                                          *
 * History : Date      Reason                                               *
 *           99-09-05  Created                                              *
 *                                                                          *
 ...
 * Function: emitdefs                                                       *
 *                                                                          *
 * Purpose : Emit nonterminal defines and data structures.                  *
 *                                                                          *
 * History : Date      Reason                                               *
 *           99-09-05  Created                                              *
 *                                                                          *
 ...
 * Function: emitheader                                                     *
 *                                                                          *
 * Purpose : Emit initial definitions.                                      *
 *                                                                          *
 * History : Date      Reason                                               *
 *           99-09-05  Created                                              *
 *                                                                          *
 ...
 *                                                                          *
 * Purpose : Compute paths to kids in tree t.                               *
 *                                                                          *
 * History : Date      Reason                                               *
 *           99-09-05  Created                                              *
 *                                                                          *
...
static void emitlabel(Term terms, Nonterm start, int ntnumber)
{
    ...
    print("%1STATE_LABEL(a) = p = memalloc(sizeof *p, funca);\n"
        "%1p->rule._stmt = 0;\n");
 ...
 * Function: computents                                                     *
 *                                                                          *
 * Purpose : Fill in bp with _nts vector for tree t.                        *
 *                                                                          *
 * History : Date      Reason                                               *
 *           99-09-05  Created                                              *
 *                                                                          *
 ...
 * Function: emitnts                                                        *
 *                                                                          *
 * Purpose : Emit _nts ragged array.                                        *
 *                                                                          *
 * History : Date      Reason                                               *
 *           99-09-05  Created                                              *
 *                                                                          *
 ...
 * Function: emitrecalc                                                     *
 *                                                                          *
 * Purpose : Emit code that tests for recalculation of INDIR?(VREGP).       *
 *                                                                          *
 * History : Date      Reason                                               *
 *           99-09-05  Created                                              *
 *                                                                          *
 ...
 * Function: emitrecord                                                     *
 *                                                                          *
 * Purpose : Emit code that tests for a winning match of rule r.            *
 *                                                                          *
 * History : Date      Reason                                               *
 *           99-09-05  Created                                              *
 *                                                                          *
 ...
 * Function: emitrule                                                       *
 *                                                                          *
 * Purpose : Emit decoding vectors and _rule.                               *
 *                                                                          *
 * History : Date      Reason                                               *
 *           99-09-05  Created                                              *
 *                                                                          *
 ...
 * Function: emitstring                                                     *
 *                                                                          *
 * Purpose : Emit arrays of templates, instruction flags, and rules.        *
 *                                                                          *
 * History : Date      Reason                                               *
 *           99-09-05  Created                                              *
 *                                                                          *
 ...
 * Function: emitstruct                                                     *
 *                                                                          *
 * Purpose : Emit the definition of the state structure.                    *
 *                                                                          *
 * History : Date      Reason                                               *
 *           99-09-05  Created                                              *
 *                                                                          *
 ...
 * Function: emittest                                                       *
 *                                                                          *
 * Purpose : Emit clause for testing a match.                               *
 *                                                                          *
 * History : Date      Reason                                               *
 *           99-09-05  Created                                              *
 *                                                                          *
