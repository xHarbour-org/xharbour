 ...
 * File    : bprint.c                                                       *
 *                                                                          *
 * Purpose : Annotate listings of files with prof.out data.                 *
 *                                                                          *
 * History : Date      Reason                                               *
 *           01-12-31  Created                                              *
 *                                                                          *
 ...
 * Function: alloc                                                          *
 *                                                                          *
 * Purpose : Allocate n bytes or die.                                       *
 *                                                                          *
 * History : Date      Reason                                               *
 *           01-21-31  Created                                              *
 *                                                                          *
 ...
 * Function: emitdata                                                       *
 *                                                                          *
 * Purpose : Write prof.out data to file.                                   *
 *                                                                          *
 * History : Date      Reason                                               *
 *           01-21-31  Created                                              *
 *                                                                          *
 ...
 * Function: openfile                                                       *
 *                                                                          *
 * Purpose : Open name for reading, searching -I directories.               *
 *                                                                          *
 * History : Date      Reason                                               *
 *           01-21-31  Created                                              *
 *                                                                          *
 ...
 * Function: printfile                                                      *
 *                                                                          *
 * Purpose : Print annotated listing for p.                                 *
 *                                                                          *
 * History : Date      Reason                                               *
 *           01-21-31  Created                                              *
 *                                                                          *
 ...
 * Function: printfuncs                                                     *
 *                                                                          *
 * Purpose : Summarize data for functions in p.                             *
 *                                                                          *
 * History : Date      Reason                                               *
 *           01-21-31  Created                                              *
 *                                                                          *
 ...
 * Function: string                                                         *
 *                                                                          *
 * Purpose : Save a copy of str, if necessary.                              *
 *                                                                          *
 * History : Date      Reason                                               *
 *           01-21-31  Created                                              *
 *                                                                          *
 ...
 * Function: acaller                                                        *
 *                                                                          *
 * Purpose : Add caller and site (file,x,y) to callee's callers list.       *
 *                                                                          *
 * History : Date      Reason                                               *
 *           01-21-31  Created                                              *
 *                                                                          *
 ...
 * Function: compare                                                        *
 *                                                                          *
 * Purpose : Return <0, 0, >0 if a<b, a==b, a>b, resp.                      *
 *                                                                          *
 * History : Date      Reason                                               *
 *           01-21-31  Created                                              *
 *                                                                          *
 ...
 * Function: findfile                                                       *
 *                                                                          *
 * Purpose : Return file name's file list entry, or 0.                      *
 *                                                                          *
 * History : Date      Reason                                               *
 *           01-21-31  Created                                              *
 *                                                                          *
 ...
 * Function: afunction                                                      *
 *                                                                          *
 * Purpose : Add function name and its data to file's function list.        *
 *                                                                          *
 * History : Date      Reason                                               *
 *           01-21-31  Created                                              *
 *                                                                          *
 ...
 * Function: apoint                                                         *
 *                                                                          *
 * Purpose : Append execution point i to file's data.                       *
 *                                                                          *
 * History : Date      Reason                                               *
 *           01-21-31  Created                                              *
 *                                                                          *
 ...
 * Function: findcount                                                      *
 *                                                                          *
 * Purpose : Return count associated with (file,x,y) or -1.                 *
 *                                                                          *
 * History : Date      Reason                                               *
 *           01-21-31  Created                                              *
 *                                                                          *
 ...
 * Function: findfunc                                                       *
 *                                                                          *
 * Purpose : Return count associated with function name in file or -1.      *
 *                                                                          *
 * History : Date      Reason                                               *
 *           01-21-31  Created                                              *
 *                                                                          *
...
int findfunc(char *name, char *file)
{
    ...
    if (cursor)
    {
        ...
        for (p = cursor->funcs; p != 0; p = p->link)
            if (p->name == name) return p->count.count;
    }
 ...
 * Function: getd                                                           *
 *                                                                          *
 * Purpose : Read a nonnegative number.                                     *
 *                                                                          *
 * History : Date      Reason                                               *
 *           01-21-31  Created                                              *
 *                                                                          *
 ...
 * Function: gather                                                         *
 *                                                                          *
 * Purpose : Read prof.out data from fd.                                    *
 *                                                                          *
 * History : Date      Reason                                               *
 *           01-21-31  Created                                              *
 *                                                                          *
 ...
 * Function: process                                                        *
 *                                                                          *
 * Purpose : Read prof.out data from file.                                  *
 *                                                                          *
 * History : Date      Reason                                               *
 *           01-21-31  Created                                              *
 *                                                                          *
