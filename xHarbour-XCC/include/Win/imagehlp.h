...
typedef BOOL (__stdcall *PIMAGEHLP_STATUS_ROUTINE)(IMAGEHLP_STATUS_REASON,PSTR,PSTR,ULONG_PTR,ULONG_PTR);
...
BOOL IMAGEAPI BindImage(PSTR,PSTR,PSTR);
BOOL IMAGEAPI BindImageEx(DWORD,PSTR,PSTR,PSTR,PIMAGEHLP_STATUS_ROUTINE);
BOOL IMAGEAPI ReBaseImage(PSTR,PSTR,BOOL,BOOL,BOOL,ULONG,ULONG*,ULONG_PTR*,ULONG*,ULONG_PTR*,ULONG);
BOOL IMAGEAPI ReBaseImage64(PSTR,PSTR,BOOL,BOOL,BOOL,ULONG,ULONG*,ULONG64*,ULONG*,ULONG64*,ULONG);
PIMAGE_NT_HEADERS IMAGEAPI CheckSumMappedFile(PVOID,DWORD,PDWORD,PDWORD);
DWORD IMAGEAPI MapFileAndCheckSumA(PSTR,PDWORD,PDWORD);
DWORD IMAGEAPI MapFileAndCheckSumW(PWSTR,PDWORD,PDWORD);
...
PLOADED_IMAGE IMAGEAPI ImageLoad(PSTR,PSTR);
BOOL IMAGEAPI ImageUnload(PLOADED_IMAGE);
BOOL IMAGEAPI MapAndLoad(PSTR,PSTR,PLOADED_IMAGE,BOOL,BOOL);
BOOL IMAGEAPI UnMapAndLoad(PLOADED_IMAGE);
BOOL IMAGEAPI TouchFileTimes(HANDLE,PSYSTEMTIME);
BOOL IMAGEAPI SplitSymbols(PSTR,PSTR,PSTR,DWORD);
BOOL IMAGEAPI UpdateDebugInfoFile(PSTR,PSTR,PSTR,PIMAGE_NT_HEADERS32);
BOOL IMAGEAPI UpdateDebugInfoFileEx(PSTR,PSTR,PSTR,PIMAGE_NT_HEADERS32,DWORD);
