...
DECLARE_INTERFACE_(IDirectPlay8Client, IUnknown)
{
    ...
    STDMETHOD(Initialize)(THIS_ PVOID const,const PFNDPNMESSAGEHANDLER,const DWORD) PURE;
    STDMETHOD(EnumServiceProviders)(THIS_ const GUID * const,const GUID * const,DPN_SERVICE_PROVIDER_INFO * const,PDWORD const,PDWORD const,const DWORD) PURE;
    STDMETHOD(EnumHosts)(THIS_ PDPN_APPLICATION_DESC const,IDirectPlay8Address * const,IDirectPlay8Address * const,PVOID const,const DWORD,const DWORD,const DWORD,const DWORD,PVOID const,DPNHANDLE * const,const DWORD) PURE;
    STDMETHOD(CancelAsyncOperation)(THIS_ const DPNHANDLE,const DWORD) PURE;
    STDMETHOD(Connect)(THIS_ const DPN_APPLICATION_DESC * const,IDirectPlay8Address * const,IDirectPlay8Address * const,const DPN_SECURITY_DESC * const,const DPN_SECURITY_CREDENTIALS * const,const void * const,const DWORD,void * const,DPNHANDLE * const,const DWORD) PURE;
    STDMETHOD(Send)(THIS_ const DPN_BUFFER_DESC * const,const DWORD,const DWORD,void *const,DPNHANDLE * const,const DWORD) PURE;
    STDMETHOD(GetSendQueueInfo)(THIS_ DWORD * const,DWORD * const,const DWORD) PURE;
    STDMETHOD(GetApplicationDesc)(THIS_ DPN_APPLICATION_DESC * const,DWORD * const, const DWORD) PURE;
    STDMETHOD(SetClientInfo)(THIS_ const DPN_PLAYER_INFO * const,PVOID const,DPNHANDLE * const,const DWORD) PURE;
    STDMETHOD(GetServerInfo)(THIS_ DPN_PLAYER_INFO * const,DWORD * const,const DWORD) PURE;
    STDMETHOD(GetServerAddress)(THIS_ IDirectPlay8Address ** const,const DWORD) PURE;
    STDMETHOD(Close)(THIS_ const DWORD) PURE;
    STDMETHOD(ReturnBuffer)(THIS_ const DPNHANDLE,const DWORD) PURE;
    STDMETHOD(GetCaps)(THIS_ DPN_CAPS * const,const DWORD) PURE;
    STDMETHOD(SetCaps)(THIS_ const DPN_CAPS * const,const DWORD) PURE;
    STDMETHOD(SetSPCaps)(THIS_ const GUID * const,const DPN_SP_CAPS * const,const DWORD) PURE;
    STDMETHOD(GetSPCaps)(THIS_ const GUID * const,DPN_SP_CAPS * const,const DWORD) PURE;
    STDMETHOD(GetConnectionInfo)(THIS_ DPN_CONNECTION_INFO * const,const DWORD) PURE;
    STDMETHOD(RegisterLobby)(THIS_ const DPNHANDLE,struct IDirectPlay8LobbiedApplication * const,const DWORD) PURE;
};
...
DECLARE_INTERFACE_(IDirectPlay8Server, IUnknown)
{
    ...
    STDMETHOD(EnumServiceProviders)(THIS_ const GUID * const,const GUID * const,DPN_SERVICE_PROVIDER_INFO * const,PDWORD const,PDWORD const,const DWORD) PURE;
    STDMETHOD(CancelAsyncOperation)(THIS_ const DPNHANDLE,const DWORD) PURE;
    STDMETHOD(GetSendQueueInfo)(THIS_ const DPNID,DWORD * const,DWORD * const,const DWORD) PURE;
    STDMETHOD(GetApplicationDesc)(THIS_ DPN_APPLICATION_DESC * const,DWORD * const,const DWORD) PURE;
    STDMETHOD(SetServerInfo)(THIS_ const DPN_PLAYER_INFO * const,PVOID const,DPNHANDLE * const,const DWORD) PURE;
    STDMETHOD(GetClientInfo)(THIS_ const DPNID,DPN_PLAYER_INFO * const,DWORD * const,const DWORD) PURE;
    STDMETHOD(GetClientAddress)(THIS_ const DPNID,IDirectPlay8Address ** const,const DWORD) PURE;
    STDMETHOD(GetLocalHostAddresses)(THIS_ IDirectPlay8Address ** const,DWORD * const,const DWORD) PURE;
    STDMETHOD(SetApplicationDesc)(THIS_ const DPN_APPLICATION_DESC * const,const DWORD) PURE;
    STDMETHOD(Host)(THIS_ const DPN_APPLICATION_DESC * const,IDirectPlay8Address ** const,const DWORD,const DPN_SECURITY_DESC * const,const DPN_SECURITY_CREDENTIALS * const,void *const,const DWORD) PURE;
    STDMETHOD(SendTo)(THIS_ const DPNID,const DPN_BUFFER_DESC * const,const DWORD,const DWORD,void *const,DPNHANDLE * const,const DWORD) PURE;
    STDMETHOD(CreateGroup)(THIS_ const DPN_GROUP_INFO * const,void *const,void *const,DPNHANDLE * const,const DWORD) PURE;
    STDMETHOD(DestroyGroup)(THIS_ const DPNID,PVOID const,DPNHANDLE * const,const DWORD) PURE;
    STDMETHOD(AddPlayerToGroup)(THIS_ const DPNID,const DPNID,PVOID const,DPNHANDLE * const,const DWORD) PURE;
    STDMETHOD(RemovePlayerFromGroup)(THIS_ const DPNID,const DPNID,PVOID const,DPNHANDLE * const,const DWORD) PURE;
    STDMETHOD(SetGroupInfo)(THIS_ const DPNID,DPN_GROUP_INFO * const,PVOID const,DPNHANDLE * const,const DWORD) PURE;
    STDMETHOD(GetGroupInfo)(THIS_ const DPNID,DPN_GROUP_INFO * const,DWORD * const,const DWORD) PURE;
    STDMETHOD(EnumPlayersAndGroups)(THIS_ DPNID * const,DWORD * const,const DWORD) PURE;
    STDMETHOD(EnumGroupMembers)(THIS_ const DPNID,DPNID * const,DWORD * const,const DWORD) PURE;
    STDMETHOD(Close)(THIS_ const DWORD) PURE;
    STDMETHOD(DestroyClient)(THIS_ const DPNID,const void *const,const DWORD,const DWORD) PURE;
    STDMETHOD(ReturnBuffer)(THIS_ const DPNHANDLE,const DWORD) PURE;
    STDMETHOD(GetPlayerContext)(THIS_ const DPNID,PVOID * const, const DWORD) PURE;
    STDMETHOD(GetGroupContext)(THIS_ const DPNID,PVOID * const,const DWORD) PURE;
    STDMETHOD(GetCaps)(THIS_ DPN_CAPS * const,const DWORD) PURE;
    STDMETHOD(SetCaps)(THIS_ const DPN_CAPS * const,const DWORD) PURE;
    STDMETHOD(SetSPCaps)(THIS_ const GUID * const,const DPN_SP_CAPS * const,const DWORD) PURE;
    STDMETHOD(GetSPCaps)(THIS_ const GUID * const,DPN_SP_CAPS * const,const DWORD) PURE;
    STDMETHOD(GetConnectionInfo)(THIS_ const DPNID,DPN_CONNECTION_INFO * const,const DWORD) PURE;
    STDMETHOD(RegisterLobby)(THIS_ const DPNHANDLE,struct IDirectPlay8LobbiedApplication * const,const DWORD) PURE;
};
...
DECLARE_INTERFACE_(IDirectPlay8Peer, IUnknown)
{
    ...
    STDMETHOD_(ULONG, Release)(THIS) PURE;
    STDMETHOD(Initialize)(THIS_ PVOID const,const PFNDPNMESSAGEHANDLER,const DWORD) PURE;
    STDMETHOD(EnumServiceProviders)(THIS_ const GUID * const,const GUID * const,DPN_SERVICE_PROVIDER_INFO * const,DWORD * const,DWORD * const,const DWORD) PURE;
    STDMETHOD(CancelAsyncOperation)(THIS_ const DPNHANDLE,const DWORD) PURE;
    STDMETHOD(Connect)(THIS_ const DPN_APPLICATION_DESC * const,IDirectPlay8Address * const,IDirectPlay8Address * const,const DPN_SECURITY_DESC * const,const DPN_SECURITY_CREDENTIALS * const,const void *const,const DWORD,void *const,void *const,DPNHANDLE * const,const DWORD) PURE;
    STDMETHOD(SendTo)(THIS_ const DPNID,const DPN_BUFFER_DESC * const,const DWORD,const DWORD,void *const,DPNHANDLE * const,const DWORD) PURE;
    STDMETHOD(GetSendQueueInfo)(THIS_ const DPNID,DWORD * const,DWORD * const,const DWORD) PURE;
    STDMETHOD(Host)(THIS_ const DPN_APPLICATION_DESC * const,IDirectPlay8Address ** const,const DWORD,const DPN_SECURITY_DESC * const,const DPN_SECURITY_CREDENTIALS * const,void *const,const DWORD) PURE;
    STDMETHOD(GetApplicationDesc)(THIS_ DPN_APPLICATION_DESC * const,DWORD * const,const DWORD) PURE;
    ...
    STDMETHOD(EnumPlayersAndGroups)(THIS_ DPNID * const,DWORD * const,const DWORD) PURE;
    STDMETHOD(EnumGroupMembers)(THIS_ const DPNID,DPNID * const,DWORD * const,const DWORD) PURE;
    STDMETHOD(SetPeerInfo)(THIS_ const DPN_PLAYER_INFO * const,PVOID const,DPNHANDLE * const,const DWORD) PURE;
    STDMETHOD(GetPeerInfo)(THIS_ const DPNID,DPN_PLAYER_INFO * const,DWORD * const,const DWORD) PURE;
    STDMETHOD(GetPeerAddress)(THIS_ const DPNID,IDirectPlay8Address ** const,const DWORD) PURE;
    STDMETHOD(GetLocalHostAddresses)(THIS_ IDirectPlay8Address ** const,DWORD * const,const DWORD) PURE;
    STDMETHOD(Close)(THIS_ const DWORD) PURE;
    STDMETHOD(EnumHosts)(THIS_ PDPN_APPLICATION_DESC const,IDirectPlay8Address * const,IDirectPlay8Address * const,PVOID const,const DWORD,const DWORD,const DWORD,const DWORD,PVOID const,DPNHANDLE * const,const DWORD) PURE;
    STDMETHOD(DestroyPeer)(THIS_ const DPNID,const void *const,const DWORD,const DWORD) PURE;
    STDMETHOD(ReturnBuffer)(THIS_ const DPNHANDLE,const DWORD) PURE;
    STDMETHOD(GetPlayerContext)(THIS_ const DPNID,PVOID * const,const DWORD) PURE;
    STDMETHOD(GetGroupContext)(THIS_ const DPNID,PVOID * const,const DWORD) PURE;
    STDMETHOD(GetCaps)(THIS_ DPN_CAPS * const,const DWORD) PURE;
    ...
    STDMETHOD(GetConnectionInfo)(THIS_ const DPNID,DPN_CONNECTION_INFO * const,const DWORD) PURE;
    STDMETHOD(RegisterLobby)(THIS_ const DPNHANDLE,struct IDirectPlay8LobbiedApplication * const,const DWORD) PURE;
    STDMETHOD(TerminateSession)(THIS_ void *const,const DWORD,const DWORD) PURE;
};
