...
#define CreateDialogParamA(hInstance,lpszDlgName,hwndOwner,lpfnDialog,lParam) \
    CreateDialogIndirectParamA(hInstance,(LPCDLGTEMPLATEA)LoadResource(hInstance,FindResource(hInstance,lpszDlgName,RT_DIALOG)),hwndOwner,lpfnDialog,lParam)
#define CreateDialogParamW(hInstance,lpszDlgName,hwndOwner,lpfnDialog,lParam) \
    CreateDialogIndirectParamW(hInstance,(LPCDLGTEMPLATEW)LoadResource(hInstance,FindResource(hInstance,lpszDlgName,RT_DIALOG)),hwndOwner,lpfnDialog,lParam)
#else /* _WINCE */
...
#ifdef _WINCE
#define MsgWaitForMultipleObjects(cnt,hndl,wa,ms,wm)  MsgWaitForMultipleObjectsEx(cnt,hndl,ms,wm,0)
#else
...
#ifdef _WINCE
#define DialogBoxParamA(hInstance,lpszDlgName,hwndOwner,lpfnDialog,lParam)  DialogBoxIndirectParamA(hInstance,(LPCDLGTEMPLATEA)LoadResource(hInstance,FindResource(hInstance,lpszDlgName,RT_DIALOG)),hwndOwner,lpfnDialog,lParam)
#define DialogBoxParamW(hInstance,lpszDlgName,hwndOwner,lpfnDialog,lParam)  DialogBoxIndirectParamW(hInstance,(LPCDLGTEMPLATEW)LoadResource(hInstance,FindResource(hInstance,lpszDlgName,RT_DIALOG)),hwndOwner,lpfnDialog,lParam)
#endif /* _WINCE */
