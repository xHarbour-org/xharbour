...
#ifdef _WINCE
    INTERNET_SCHEME_ABOUT,  /* Smartphone only? */
    INTERNET_SCHEME_RES,  /* Smartphone only? */
#endif
...
#else
CommitUrlCacheEntryA(LPCSTR,LPCSTR,FILETIME,FILETIME,DWORD,LPCSTR,DWORD,LPCSTR,LPCSTR);
CommitUrlCacheEntryW(LPCWSTR,LPCWSTR,FILETIME,FILETIME,DWORD,LPCWSTR,DWORD,LPCWSTR,LPCWSTR);
