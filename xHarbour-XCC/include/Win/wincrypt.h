...
typedef BOOL (WINAPI *PFN_CERT_DLL_OPEN_STORE_PROV_FUNC)(LPCSTR,DWORD,HCRYPTPROV,DWORD,const void*,HCERTSTORE,PCERT_STORE_PROV_INFO);
...
WINCRYPT32API HCRYPTMSG WINAPI CryptMsgOpenToDecode(DWORD,DWORD,DWORD,HCRYPTPROV,PCERT_INFO,PCMSG_STREAM_INFO);
...
WINCRYPT32API HCERTSTORE WINAPI CertOpenStore(LPCSTR,DWORD,HCRYPTPROV,DWORD,const void*);
...
WINCRYPT32API BOOL WINAPI CryptVerifyCertificateSignature(HCRYPTPROV,DWORD,const BYTE*,DWORD,PCERT_PUBLIC_KEY_INFO);
WINCRYPT32API BOOL WINAPI CryptVerifyCertificateSignatureEx(HCRYPTPROV,DWORD,DWORD,void*,DWORD,void*,DWORD,void*);
WINCRYPT32API BOOL WINAPI CryptHashToBeSigned(HCRYPTPROV,DWORD,const BYTE*,DWORD,BYTE*,DWORD*);
WINCRYPT32API BOOL WINAPI CryptHashCertificate(HCRYPTPROV,ALG_ID,DWORD,const BYTE*,DWORD,BYTE*,DWORD*);
...
WINCRYPT32API BOOL WINAPI CryptHashPublicKeyInfo(HCRYPTPROV,ALG_ID,DWORD,DWORD,PCERT_PUBLIC_KEY_INFO,BYTE*,DWORD*);
...
WINCRYPT32API HCERTSTORE WINAPI CryptGetMessageCertificates(DWORD,HCRYPTPROV,DWORD,const BYTE*,DWORD);
...
WINCRYPT32API HCERTSTORE WINAPI CertOpenSystemStoreA(HCRYPTPROV,LPCSTR);
WINCRYPT32API HCERTSTORE WINAPI CertOpenSystemStoreW(HCRYPTPROV,LPCWSTR);
...
BOOL WINAPI CryptMsgVerifyCountersignatureEncoded(HCRYPTPROV,DWORD,PBYTE,DWORD,PBYTE,DWORD,PCERT_INFO);
BOOL WINAPI CryptMsgVerifyCountersignatureEncodedEx(HCRYPTPROV,DWORD,PBYTE,DWORD,PBYTE,DWORD,DWORD,void*,DWORD,void*);
