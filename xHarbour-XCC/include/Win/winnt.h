...
#if defined(_M_IA64) && (__POCC__ > 1000)
...
#define PROCESSOR_INSTRUCTION_CODE(arch,core,feature)  ((arch)<<24|(core)<<16|(feature))
...
#define PROCESSOR_X86_32BIT_INSTRUCTION  PROCESSOR_INSTRUCTION_CODE(PROCESSOR_ARCHITECTURE_INTEL,PROCESSOR_X86_32BIT_CORE,PROCESSOR_FEATURE_FP)
#define PROCESSOR_MIPS_MIPS16_INSTRUCTION  PROCESSOR_INSTRUCTION_CODE(PROCESSOR_ARCHITECTURE_MIPS,PROCESSOR_MIPS16_CORE,PROCESSOR_FEATURE_NOFP)
#define PROCESSOR_MIPS_MIPSII_INSTRUCTION  PROCESSOR_INSTRUCTION_CODE(PROCESSOR_ARCHITECTURE_MIPS,PROCESSOR_MIPSII_CORE,PROCESSOR_FEATURE_NOFP)
#define PROCESSOR_MIPS_MIPSIIFP_INSTRUCTION  PROCESSOR_INSTRUCTION_CODE(PROCESSOR_ARCHITECTURE_MIPS,PROCESSOR_MIPSII_CORE,PROCESSOR_FEATURE_FP)
#define PROCESSOR_MIPS_MIPSIV_INSTRUCTION  PROCESSOR_INSTRUCTION_CODE(PROCESSOR_ARCHITECTURE_MIPS,PROCESSOR_MIPSIV_CORE,PROCESSOR_FEATURE_NOFP)
#define PROCESSOR_MIPS_MIPSIVFP_INSTRUCTION  PROCESSOR_INSTRUCTION_CODE(PROCESSOR_ARCHITECTURE_MIPS,PROCESSOR_MIPSIV_CORE,PROCESSOR_FEATURE_FP)
#define PROCESSOR_HITACHI_SH3_INSTRUCTION  PROCESSOR_INSTRUCTION_CODE(PROCESSOR_ARCHITECTURE_SHX,PROCESSOR_HITACHI_SH3_CORE,PROCESSOR_FEATURE_NOFP)
#define PROCESSOR_HITACHI_SH3DSP_INSTRUCTION  PROCESSOR_INSTRUCTION_CODE(PROCESSOR_ARCHITECTURE_SHX,PROCESSOR_HITACHI_SH3_CORE,PROCESSOR_FEATURE_DSP)
#define PROCESSOR_HITACHI_SH4_INSTRUCTION  PROCESSOR_INSTRUCTION_CODE(PROCESSOR_ARCHITECTURE_SHX,PROCESSOR_HITACHI_SH4_CORE,PROCESSOR_FEATURE_FP)
#define PROCESSOR_ARM_V4_INSTRUCTION  PROCESSOR_INSTRUCTION_CODE(PROCESSOR_ARCHITECTURE_ARM,PROCESSOR_ARM_V4_CORE,PROCESSOR_FEATURE_NOFP)
#define PROCESSOR_ARM_V4FP_INSTRUCTION  PROCESSOR_INSTRUCTION_CODE(PROCESSOR_ARCHITECTURE_ARM,PROCESSOR_ARM_V4_CORE,PROCESSOR_FEATURE_FP)
#define PROCESSOR_ARM_V4I_INSTRUCTION  PROCESSOR_INSTRUCTION_CODE(PROCESSOR_ARCHITECTURE_ARM,PROCESSOR_ARM_V4I_CORE,PROCESSOR_FEATURE_NOFP)
#define PROCESSOR_ARM_V4IFP_INSTRUCTION  PROCESSOR_INSTRUCTION_CODE(PROCESSOR_ARCHITECTURE_ARM,PROCESSOR_ARM_V4I_CORE,PROCESSOR_FEATURE_FP)
#define PROCESSOR_ARM_V4T_INSTRUCTION  PROCESSOR_INSTRUCTION_CODE(PROCESSOR_ARCHITECTURE_ARM,PROCESSOR_ARM_V4T_CORE,PROCESSOR_FEATURE_NOFP)
#define PROCESSOR_ARM_V4TFP_INSTRUCTION  PROCESSOR_INSTRUCTION_CODE(PROCESSOR_ARCHITECTURE_ARM,PROCESSOR_ARM_V4T_CORE,PROCESSOR_FEATURE_FP)
...
#define IsReparseTagHighLatency(_tag)  (((_tag)&0x40000000))
...
} LIST_ENTRY, *PLIST_ENTRY, * /*restrict*/ PRLIST_ENTRY;
...
#if defined(_M_IX86)
__inline PVOID GetFiberData(void)  { __asm { mov eax,fs:[0x10] mov eax,[eax] } }
...
#define CONTEXT86_INTEGER  (CONTEXT_i386|0x00000002L)
#define CONTEXT86_SEGMENTS  (CONTEXT_i386|0x00000004L)
#define CONTEXT86_FLOATING_POINT  (CONTEXT_i386|0x00000008L)
#define CONTEXT86_DEBUG_REGISTERS  (CONTEXT_i386|0x00000010L)
...
#define NUM_EXTRA_CONTROL_REGS  8
    DWORD Fpscr;
    DWORD FpExc;
    DWORD S[NUM_VFP_REGS+1];
    DWORD FpExtra[NUM_EXTRA_CONTROL_REGS];
} CONTEXT, *PCONTEXT;
...
NTSYSAPI VOID NTAPI RtlCopyMemory(VOID UNALIGNED*,CONST VOID UNALIGNED*,SIZE_T);
NTSYSAPI VOID NTAPI RtlCopyMemory32(VOID UNALIGNED*,CONST VOID UNALIGNED*,DWORD);
NTSYSAPI VOID NTAPI RtlMoveMemory(VOID UNALIGNED*,CONST VOID UNALIGNED*,SIZE_T);
NTSYSAPI VOID NTAPI RtlFillMemory(VOID UNALIGNED*,SIZE_T,BYTE);
NTSYSAPI VOID NTAPI RtlZeroMemory(VOID UNALIGNED*,SIZE_T);
#else
...
ULONGLONG NTAPI VerSetConditionMask(ULONGLONG,DWORD,BYTE);
...
typedef IMAGE_THUNK_DATA6  IMAGE_THUNK_DATA;
