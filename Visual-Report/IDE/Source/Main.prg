...
//---------------------------------------------------------------------------------------------------------   
   ...
   cBuffer += "         IF oRep:nRow >= oRep:oPDF:PageLength"                                + CRLF
...
//---------------------------------------------------------------------------------------------------------   
   cBuffer += "STATIC FUNCTION " + ::GetName(,.F.) + "_PrintHeader( hDC )" + CRLF
