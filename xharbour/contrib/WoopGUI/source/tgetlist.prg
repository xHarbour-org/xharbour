...
METHOD GetApplyKey( nKey ) CLASS HBGetList
   ...
   WG_DebugTrace("TGetList:ApplyKey()", "oGet:Buffer", oGet:Buffer, "nKey", nKey)

   if ! ( ( bKeyBlock := Setkey( nKey ) ) == NIL )
      WG_DebugTrace("TXGet:ApplyKey() - ::GetDoSetKey()")
...
METHOD GetPreValidate() CLASS HBGetList
   ...
   WG_DebugTrace("TGetLIST:GetPreValidate()", "::oGet:PreBlock", ::oGet:PreBlock )
   if oGet:PreBlock != NIL
      WG_DebugTrace("TGetLIST:GetPreValidate()", "::oGet:PreBlock", IIF( ::oGet:PreBlock <> nil, EVAL( ::oGet:PreBlock ), NIL ), "::oGet:Name", ::oGet:Name )
      xValue    := oGet:VarGet()
...
METHOD Settle( nPos ) CLASS HBGetList
   ...
   WG_DebugTrace( "TGetList:Settle())", "::nPos", ::nPos, "nPos", nPos )
   ...
   if nPos == 0
      ...
      WG_DebugTrace( "TGetList:Settle())", "::aGetList[ nPos ]:Name", ::aGetList[ nPos ]:Name )
   endif

   WG_DebugTrace( "TGetList:Settle())", "nExitState", nExitState )

   if nExitState == GE_ESCAPE .or. nExitState == GE_WRITE
      return 0
   endif

   WG_DebugTrace( "TGetList:Settle())", "::nLastExitState", ::nLastExitState, "::nNextGet", ::nNextGet, "::nLastPos", ::nLastPos )
   ...
   WG_DebugTrace( "TGetList:Settle())", "::nLastPos", ::nLastPos, "nPos", nPos, "nExitState", nExitState )
