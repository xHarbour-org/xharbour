...
#undef TVE_TOGGLE
#undef TVSIL_NORMAL
#undef TVS_HASBUTTONS
#undef TVS_HASLINES
#undef TVS_LINESATROOT
#undef TVS_EDITLABELS
#undef TVS_DISABLEDRAGDROP
#undef TVS_SHOWSELALWAYS
#undef TVS_RTLREADING
#undef TVS_NOTOOLTIPS
#undef TVS_CHECKBOXES
#undef TVS_TRACKSELECT
#undef TVS_SINGLEEXPAND
#undef TVS_INFOTIP
#undef TVS_FULLROWSELECT
#undef TVS_NOSCROLL
#undef TVS_NONEVENHEIGHT
#undef TVS_NOHSCROLL
#undef TVGN_ROOT
#undef TVGN_NEXT
#undef TVGN_PREVIOUS
#undef TVGN_PARENT
#undef TVGN_CHILD
#undef TVGN_FIRSTVISIBLE
#undef TVGN_NEXTVISIBLE
#undef TVGN_PREVIOUSVISIBLE
#undef TVGN_DROPHILITE
#undef TVGN_CARET
#undef TVGN_LASTVISIBLE
#undef TVN_SELCHANGED
#undef TVN_ITEMEXPANDING
#undef TVN_BEGINLABELEDIT
#undef TVN_ENDLABELEDIT
#undef TVI_ROOT
