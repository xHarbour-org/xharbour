...
ECHO *
ECHO Linking...
rem %BCC_DIR%\bin\ilink32 -Gn -Tpe -aa -L%HB_INSTALL%\lib\;%BCC_DIR%\lib\;%WHOO%\lib\ -s @b32.bc
%BCC_DIR%\bin\ilink32 -Gn -Tpe -L%HB_INSTALL%\lib\;%BCC_DIR%\lib\;%WHOO%\lib\ -s @b32.bc
