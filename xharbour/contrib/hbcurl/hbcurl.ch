  ...
  #define HB_CURLOPT_DNS_USE_GLOBAL_CACHE 91 /* To becomeO BSOLETE soon */
  ...
  #define HB_CURLOPT_SETUPLOADFILE 137
  #define HB_CURLOPT_CLOSEUPLOADFILE 138
  #define HB_CURLOPT_SETPROGRESS 139
  #define HB_CURLOPT_SETDOWNLOADFILE 140
