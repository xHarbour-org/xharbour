...
typedef UNSIGNED32 (WINAPI *ADSSETINDEXDIRECTION_PTR)( ADSHANDLE hIndex, UNSIGNED16 usReverseDirection );

UNSIGNED32 ENTRYPOINT AdsGetDataLength( ADSHANDLE hTable, UNSIGNED8 *pucFldName, UNSIGNED32 ulOptions, UNSIGNED32 *pulLength );
typedef UNSIGNED32 (WINAPI *ADSGETDATALENGTH_PTR)( ADSHANDLE hTable, UNSIGNED8 *pucFldName, UNSIGNED32 ulOptions, UNSIGNED32 *pulLength );

UNSIGNED32 ENTRYPOINT AdsGetIndexCollation( ADSHANDLE hIndex, UNSIGNED8 *pucCollation, UNSIGNED16 *pusLen );
typedef UNSIGNED32 (WINAPI *ADSGETINDEXCOLLATION_PTR)( ADSHANDLE hIndex, UNSIGNED8 *pucCollation, UNSIGNED16 *pusLen );

UNSIGNED32 ENTRYPOINT AdsGetTableCollation( ADSHANDLE hTbl, UNSIGNED8 *pucCollation, UNSIGNED16 *pusLen );
typedef UNSIGNED32 (WINAPI *ADSGETTABLECOLLATION_PTR)( ADSHANDLE hTbl, UNSIGNED8 *pucCollation, UNSIGNED16 *pusLen );

UNSIGNED32 ENTRYPOINT AdsIsNullable( ADSHANDLE hTable, UNSIGNED8 *pucFldName, UNSIGNED16 *pbNullable );
typedef UNSIGNED32 (WINAPI *ADSISNULLABLE_PTR)( ADSHANDLE hTable, UNSIGNED8 *pucFldName, UNSIGNED16 *pbNullable );

UNSIGNED32 ENTRYPOINT AdsIsIndexNullable( ADSHANDLE hIndex, UNSIGNED16 *pbNullable );
typedef UNSIGNED32 (WINAPI *ADSISINDEXNULLABLE_PTR)( ADSHANDLE hIndex, UNSIGNED16 *pbNullable );

UNSIGNED32 ENTRYPOINT AdsSetNull( ADSHANDLE hTable, UNSIGNED8 *pucFldName );
typedef UNSIGNED32 (WINAPI *ADSSETNULL_PTR)( ADSHANDLE hTable, UNSIGNED8 *pucFldName );

UNSIGNED32 ENTRYPOINT AdsIsNull( ADSHANDLE hTable, UNSIGNED8 *pucFldName, UNSIGNED16 *pbNull );
typedef UNSIGNED32 (WINAPI *ADSISNULL_PTR)( ADSHANDLE hTable, UNSIGNED8 *pucFldName, UNSIGNED16 *pbNull );

UNSIGNED32 ENTRYPOINT AdsIsFieldBinary( ADSHANDLE hTable, UNSIGNED8 *pucFldName, UNSIGNED16 *pbBinary );
typedef UNSIGNED32 (WINAPI *ADSISFIELDBINARY_PTR)( ADSHANDLE hTable, UNSIGNED8 *pucFldName, UNSIGNED16 *pbBinary );

UNSIGNED32 ENTRYPOINT AdsRegisterUDF( ADSHANDLE hObj, UNSIGNED16 usType, UNSIGNED32 (WINAPI *lpfnUDF)(void) );
typedef UNSIGNED32 (WINAPI *ADSREGISTERUDF_PTR)( ADSHANDLE hObj, UNSIGNED16 usType, UNSIGNED32 (WINAPI *lpfnUDF)(void) );

UNSIGNED32 ENTRYPOINT AdsStmtSetTableCollation( ADSHANDLE hStatement, UNSIGNED8 *pucCollation );
typedef UNSIGNED32 (WINAPI *ADSSTMTSETTABLECOLLATION_PTR)( ADSHANDLE hStatement, UNSIGNED8 *pucCollation );

UNSIGNED32 ENTRYPOINT AdsSkipUnique( ADSHANDLE hIndex, SIGNED32 lRecs );
typedef UNSIGNED32 (WINAPI *ADSSKIPUNIQUE_PTR)( ADSHANDLE hIndex, SIGNED32 lRecs );

UNSIGNED32 ENTRYPOINT AdsSetCollation( ADSHANDLE hConnect, UNSIGNED8 *pucCollation );
typedef UNSIGNED32 (WINAPI *ADSSETCOLLATION_PTR)( ADSHANDLE hConnect, UNSIGNED8 *pucCollation );

UNSIGNED32 ENTRYPOINT AdsIsIndexCandidate( ADSHANDLE hIndex, UNSIGNED16 *pbCandidate );
typedef UNSIGNED32 (WINAPI *ADSISINDEXCANDIDATE_PTR)( ADSHANDLE hIndex, UNSIGNED16 *pbCandidate );

UNSIGNED32 ENTRYPOINT AdsGetCollation( ADSHANDLE hConnect, UNSIGNED8 *pucCollation, UNSIGNED16 *pusLen );
typedef UNSIGNED32 (WINAPI *ADSGETCOLLATION_PTR)( ADSHANDLE hConnect, UNSIGNED8 *pucCollation, UNSIGNED16 *pusLen );
...
typedef UNSIGNED32 (WINAPI *ADSCREATEINDEX90_PTR)( ADSHANDLE hObj, UNSIGNED8 *pucFileName, UNSIGNED8 *pucTag, UNSIGNED8 *pucExpr, UNSIGNED8 *pucCondition, UNSIGNED8 *pucWhile, UNSIGNED32 ulOptions, UNSIGNED32 ulPageSize, UNSIGNED8 *pucCollation, ADSHANDLE *phIndex );
...
typedef UNSIGNED32 (WINAPI *ADSCREATETABLE90_PTR)( ADSHANDLE hConnection, UNSIGNED8 *pucName, UNSIGNED8 *pucDBObjName, UNSIGNED16 usTableType, UNSIGNED16 usCharType, UNSIGNED16 usLockType, UNSIGNED16 usCheckRights, UNSIGNED16 usMemoSize, UNSIGNED8 *pucFields, UNSIGNED32 ulOptions, UNSIGNED8 *pucCollation, ADSHANDLE *phTable );
...
typedef UNSIGNED32 (WINAPI *ADSDDADDTABLE90_PTR)( ADSHANDLE hDictionary, UNSIGNED8 *pucTableName, UNSIGNED8 *pucTablePath, UNSIGNED16 usTableType, UNSIGNED16 usCharType, UNSIGNED8 *pucIndexFiles, UNSIGNED8 *pucComments, UNSIGNED8 *pucCollation );
...
typedef UNSIGNED32 (WINAPI *ADSOPENTABLE90_PTR)( ADSHANDLE hConnect, UNSIGNED8 *pucName, UNSIGNED8 *pucAlias, UNSIGNED16 usTableType, UNSIGNED16 usCharType, UNSIGNED16 usLockType, UNSIGNED16 usCheckRights, UNSIGNED32 ulOptions, UNSIGNED8 *pucCollation, ADSHANDLE *phTable );
...
typedef UNSIGNED32 (WINAPI *ADSRESTRUCTURETABLE90_PTR)( ADSHANDLE hObj, UNSIGNED8 *pucName, UNSIGNED8 *pucPassword, UNSIGNED16 usTableType, UNSIGNED16 usCharType, UNSIGNED16 usLockType, UNSIGNED16 usCheckRights, UNSIGNED8 *pucAddFields, UNSIGNED8 *pucDeleteFields, UNSIGNED8 *pucChangeFields, UNSIGNED8 *pucCollation );
//
#endif                                                        
