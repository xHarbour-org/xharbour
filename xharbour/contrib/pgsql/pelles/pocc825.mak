...
#
# NOTE: This make was tested on Postgresql-8.2.5 release.
...
CC_FLAGS = /Ze /Ot /Ox /Go /Tx86-coff /I"$(CC_DIR)\include" /I"$(CC_DIR)\include\win" /I"..\..\include" /I"..\..\include\port\win32" /I"..\..\include\port\win32_msvc" /I"..\..\port" $(USERDEFINES) 
...
CLEAN :
        -@erase $(OBJ_DIR)\getaddrinfo.obj
        -@erase $(OBJ_DIR)\pgstrcasecmp.obj
        -@erase $(OBJ_DIR)\thread.obj
        -@erase $(OBJ_DIR)\inet_aton.obj
        -@erase $(OBJ_DIR)\crypt.obj
        -@erase $(OBJ_DIR)\noblock.obj
        -@erase $(OBJ_DIR)\md5.obj
        -@erase $(OBJ_DIR)\ip.obj
        -@erase $(OBJ_DIR)\fe-auth.obj
        -@erase $(OBJ_DIR)\fe-protocol2.obj
        -@erase $(OBJ_DIR)\fe-protocol3.obj
        -@erase $(OBJ_DIR)\fe-connect.obj
        -@erase $(OBJ_DIR)\fe-exec.obj
        -@erase $(OBJ_DIR)\fe-lobj.obj
        -@erase $(OBJ_DIR)\fe-misc.obj
        -@erase $(OBJ_DIR)\fe-print.obj
        -@erase $(OBJ_DIR)\fe-secure.obj
        -@erase $(OBJ_DIR)\pqexpbuffer.obj
        -@erase $(OBJ_DIR)\pqsignal.obj
        -@erase $(OBJ_DIR)\win32.obj
        -@erase $(OBJ_DIR)\wchar.obj
        -@erase $(OBJ_DIR)\encnames.obj
        -@erase $(OBJ_DIR)\pthread-win32.obj
        -@erase $(OBJ_DIR)\snprintf.obj
        -@erase $(OBJ_DIR)\strlcpy.obj
        -@erase $(OBJ_DIR)\$(OUTFILENAME).lib
        -@erase $(OBJ_DIR)\libpq.res
        -@erase $(OBJ_DIR)\pg_config_paths.h
