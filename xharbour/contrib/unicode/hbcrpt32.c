/*
 * $Id: hbcrpt32.c,v 1.1 2004/01/14 13:59:52 andijahja Exp $
 */
...
HB_FUNC(HB_ENCRYPT32) //(cStr)->cEnc
{
	...
	BYTE *srcstr,*dststr;
	if (phbpsw) int_cryptbl((BYTE*) hb_itemGetCPtr(phbpsw),hb_itemGetCLen(phbpsw));
	else int_cryptbl((BYTE*)"",0);
	if (phbstr) {
