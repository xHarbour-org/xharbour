...
METHOD New( nRows, nCols, cTitle, cFont, nFontHeight, nFontWidth ) CLASS wvtDialog
...
LOCAL aPalette, cScr, cQry, n, i, j
...
Wvt_SetFont( ::cFont, ::nFontHeight, ::nFontWidth )
SetMode( ::nRows, ::nCols )
Wvt_SetTitle( ::cTitle )
...
Wvt_SetFont( ::aOldFont[ 1 ], ::aOldFont[ 2 ], ::aOldFont[ 3 ] )
...
if valtype( ::bHandleEvent ) == 'B'
   eval( ::bHandleEvent, self, ::oParent:cPaintBlockID, ::oBrw, nKey )
endif
...
LOCAL nmRow, nmCol, nOff, nNewPos
LOCAL lHit  := .F.
