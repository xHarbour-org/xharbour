...
HB_FUNC( WVT_DRAWBUTTON )
{
   ...
   {
      case 1:
         hb_wvt_gtDrawBoxRecessed( iTop+2, iLeft+2, iBottom-2, iRight-2 );
         break;
      case 2:
         break;
      case 3:
         hb_wvt_gtDrawOutline( iTop+1, iLeft+1, iBottom-1, iRight-1 );
         break;
      default:
         hb_wvt_gtDrawBoxRaised( iTop+2, iLeft+2, iBottom-2, iRight-2 );
         break;
   }
