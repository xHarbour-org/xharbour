/*
 * $Id: cdpapi.c,v 1.31 2007/09/23 05:02:15 andijahja Exp $
 */
...
HB_EXPORT ULONG hb_cdpUTF8StringPeek( const BYTE * pSrc, ULONG ulLen,
                                      ULONG ulPos )
{
   if( ulLen )
   {
...
HB_FUNC( HB_UTF8SUBSTR )
{
   ...
   if( ISCHAR( 1 ) && ( iPCount < 2 ||
       ( ISNUM( 2 ) && ( iPCount < 3 || ISNUM( 3 ) ) ) ) )
   {
