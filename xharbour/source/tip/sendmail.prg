...
FUNCTION HB_SetMimeType( cFile )
   ...
   IF     cFile LIKE ".+\.(3dmf|3dm|qd3d|qd3)"         ; RETURN "x-world/x-3dmf"
   ELSEIF cFile LIKE ".+\.(aam|aas)"                   ; RETURN "application/x-authorware-map"
   ELSEIF cFile LIKE ".+\.(aif|aiff|aifc)"             ; RETURN "audio/x-aiff"
   ELSEIF cFile LIKE ".+\.(ai|eps|ps)"                 ; RETURN "application/postscript"
   ELSEIF cFile LIKE ".+\.(asf|asx)"                   ; RETURN "video/x-ms-asf"
   ELSEIF cFile LIKE ".+\.(asn|asz|asd)"               ; RETURN "application/astound"
   ELSEIF cFile LIKE ".+\.(au|snd)"                    ; RETURN "audio/basic"
   ELSEIF cFile LIKE ".+\.(bin|class|lha|lzh|lzx|dbf)" ; RETURN "application/octet-stream"
   ELSEIF cFile LIKE ".+\.(cht|dus)"                   ; RETURN "audio/x-dspeech"
   ELSEIF cFile LIKE ".+\.(coda|page)"                 ; RETURN "application/x-coda"
   ELSEIF cFile LIKE ".+\.(cu|csm)"                    ; RETURN "application/x-cu-seeme"
   ELSEIF cFile LIKE ".+\.(dcr|dir|dxr|swa)"           ; RETURN "application/x-director"
   ELSEIF cFile LIKE ".+\.(fh5|fh4|fhc)"               ; RETURN "image/x-freehand"
   ELSEIF cFile LIKE ".+\.(gsm|gsd)"                   ; RETURN "audio/gsm"
   ELSEIF cFile LIKE ".+\.(htm|html)"                  ; RETURN "text/html"
   ELSEIF cFile LIKE ".+\.(jpeg|jpg|jpe)"              ; RETURN "image/jpeg"
   ELSEIF cFile LIKE ".+\.(mid|midi)"                  ; RETURN "audio/x-midi"
   ELSEIF cFile LIKE ".+\.(mpeg|mpg|mpe)"              ; RETURN "video/mpeg"
   ELSEIF cFile LIKE ".+\.(mpl|mpire)"                 ; RETURN "application/x-mpire"
   ELSEIF cFile LIKE ".+\.(nc|cdf)"                    ; RETURN "application/x-netcdf"
   ELSEIF cFile LIKE ".+\.(pot|pps|ppt|ppz)"           ; RETURN "application/mspowerpoint"
   ELSEIF cFile LIKE ".+\.(qt|mov)"                    ; RETURN "video/quicktime"
   ELSEIF cFile LIKE ".+\.(ram|ra)"                    ; RETURN "audio/x-pn-realaudio"
   ELSEIF cFile LIKE ".+\.(sml|ofml)"                  ; RETURN "application/fml"
   ELSEIF cFile LIKE ".+\.(svf|dwg|dxf)"               ; RETURN "image/vnd"
   ELSEIF cFile LIKE ".+\.(talk|spc)"                  ; RETURN "text/x-speech"
   ELSEIF cFile LIKE ".+\.(texinfo|texi)"              ; RETURN "application/x-texinfo"
   ELSEIF cFile LIKE ".+\.(tiff|tif)"                  ; RETURN "image/tiff"
   ELSEIF cFile LIKE ".+\.(t|tr|roff)"                 ; RETURN "application/x-troff"
   ELSEIF cFile LIKE ".+\.(vgm|vgx|xdr)"               ; RETURN "video/x-videogram"
   ELSEIF cFile LIKE ".+\.(viv|vivo)"                  ; RETURN "video/vnd.vivo"
   ELSEIF cFile LIKE ".+\.(vqf|vql)"                   ; RETURN "audio/x-twinvq"
   ELSEIF cFile LIKE ".+\.(wan|waf)"                   ; RETURN "plugin/wanimate"
   ELSEIF cFile LIKE ".+\.(wrl|wrz)"                   ; RETURN "x-world/x-vrml"
   ELSEIF cFile LIKE ".+\.123"                         ; RETURN "application/vnd.lotus-1-2-3"
   ...
   ELSEIF cFile LIKE ".+\.7z"                          ; RETURN "application/x-7z-compressed"
   ELSEIF cFile LIKE ".+\.aab"                         ; RETURN "application/x-authorware-bin"
   ...
   ELSEIF cFile LIKE ".+\.ac"                          ; RETURN "application/pkix-attr-cert"
   ELSEIF cFile LIKE ".+\.adp"                         ; RETURN "audio/adpcm"
   ELSEIF cFile LIKE ".+\.adr"                         ; RETURN "application/x-msaddr"
   ELSEIF cFile LIKE ".+\.aep"                         ; RETURN "application/vnd.audiograph"
   ELSEIF cFile LIKE ".+\.afl"                         ; RETURN "video/animaflex"
   ELSEIF cFile LIKE ".+\.afp"                         ; RETURN "application/vnd.ibm.modcap"
   ELSEIF cFile LIKE ".+\.ahead"                       ; RETURN "application/vnd.ahead.space"
   ELSEIF cFile LIKE ".+\.aif"                         ; RETURN "audio/x-aiff"
   ELSEIF cFile LIKE ".+\.air"                         ; RETURN "application/vnd.adobe.air-application-installer-package+zip"
   ELSEIF cFile LIKE ".+\.ait"                         ; RETURN "application/vnd.dvb.ait"
   ELSEIF cFile LIKE ".+\.ai"                          ; RETURN "application/postscript"
   ELSEIF cFile LIKE ".+\.alt"                         ; RETURN "application/x-up-alert"
   ...
   ELSEIF cFile LIKE ".+\.arj"                         ; RETURN "application/x-arj"
   ELSEIF cFile LIKE ".+\.asf"                         ; RETURN "video/x-ms-asf"
   ELSEIF cFile LIKE ".+\.aso"                         ; RETURN "application/vnd.accpac.simply.aso"
   ELSEIF cFile LIKE ".+\.asp"                         ; RETURN "application/x-asap"
   ELSEIF cFile LIKE ".+\.atc"                         ; RETURN "application/vnd.acucorp"
   ...
   ELSEIF cFile LIKE ".+\.bed"                         ; RETURN "application/vnd.realvnc.bed"
   ELSEIF cFile LIKE ".+\.bh2"                         ; RETURN "application/vnd.fujitsu.oasysprs"
   ELSEIF cFile LIKE ".+\.bin"                         ; RETURN "application/x-macbinary"
 //ELSEIF cFile LIKE ".+\.bin"                         ; RETURN "application/octet-stream"
   ...
   ELSEIF cFile LIKE ".+\.bz2"                         ; RETURN "application/x-bzip2"
   ELSEIF cFile LIKE ".+\.bz"                          ; RETURN "application/x-bzip"
   ELSEIF cFile LIKE ".+\.c11amc"                      ; RETURN "application/vnd.cluetrust.cartomobile-config"
   ELSEIF cFile LIKE ".+\.c11amz"                      ; RETURN "application/vnd.cluetrust.cartomobile-config-pkg"
   ELSEIF cFile LIKE ".+\.c4g"                         ; RETURN "application/vnd.clonk.c4group"
   ...
   ELSEIF cFile LIKE ".+\.ccs"                         ; RETURN "text/ccs"
   ...
   ELSEIF cFile LIKE ".+\.cdmia"                       ; RETURN "application/cdmi-capability"
   ELSEIF cFile LIKE ".+\.cdmic"                       ; RETURN "application/cdmi-container"
   ELSEIF cFile LIKE ".+\.cdmid"                       ; RETURN "application/cdmi-domain"
   ELSEIF cFile LIKE ".+\.cdmio"                       ; RETURN "application/cdmi-object"
   ELSEIF cFile LIKE ".+\.cdmiq"                       ; RETURN "application/cdmi-queue"
   ...
   ELSEIF cFile LIKE ".+\.che"                         ; RETURN "application/x-up-cacheop"
   ...
   ELSEIF cFile LIKE ".+\.cnc"                         ; RETURN "application/x-cnc"
   ELSEIF cFile LIKE ".+\.cod"                         ; RETURN "image/cis-cod"
 //ELSEIF cFile LIKE ".+\.cod"                         ; RETURN "application/vnd.rim.cod"
   ELSEIF cFile LIKE ".+\.con"                         ; RETURN "application/x-connector"
   ELSEIF cFile LIKE ".+\.cpio"                        ; RETURN "application/x-cpio"
   ELSEIF cFile LIKE ".+\.cpi"                         ; RETURN "image/cpi"
   ...
   ELSEIF cFile LIKE ".+\.cryptonote"                  ; RETURN "application/vnd.rig.cryptonote"
 ...
 //ELSEIF cFile LIKE ".+\.css"                         ; RETURN "application/x-pointplus"
   ...
   ELSEIF cFile LIKE ".+\.c"                           ; RETURN "text/x-c"
   ELSEIF cFile LIKE ".+\.dae"                         ; RETURN "model/vnd.collada+xml"
   ...
   ELSEIF cFile LIKE ".+\.deb"                         ; RETURN "application/x-debian-package"
   ELSEIF cFile LIKE ".+\.der"                         ; RETURN "application/x-x509-ca-cert"
   ELSEIF cFile LIKE ".+\.dfac"                        ; RETURN "application/vnd.dreamfactory"
   ELSEIF cFile LIKE ".+\.dig"                         ; RETURN "multipart/mixed"
   ELSEIF cFile LIKE ".+\.dir"                         ; RETURN "application/x-director"
   ELSEIF cFile LIKE ".+\.dis"                         ; RETURN "application/vnd.mobius.dis"
   ELSEIF cFile LIKE ".+\.djvu"                        ; RETURN "image/vnd.djvu"
   ...
   ELSEIF cFile LIKE ".+\.doc"                         ; RETURN "application/msword"
   ...
   ELSEIF cFile LIKE ".+\.dra"                         ; RETURN "audio/vnd.dra"
   ELSEIF cFile LIKE ".+\.dsc"                         ; RETURN "text/prs.lines.tag"
   ELSEIF cFile LIKE ".+\.dsf"                         ; RETURN "image/x-mgx-dsf"
   ELSEIF cFile LIKE ".+\.dssc"                        ; RETURN "application/dssc+der"
   ELSEIF cFile LIKE ".+\.dst"                         ; RETURN "application/tajima"
   ...
   ELSEIF cFile LIKE ".+\.dwf"                         ; RETURN "drawing/x-dwf"
 //ELSEIF cFile LIKE ".+\.dwf"                         ; RETURN "model/vnd.dwf"
   ...
   ELSEIF cFile LIKE ".+\.ebk"                         ; RETURN "application/x-expandedbook"
   ...
   ELSEIF cFile LIKE ".+\.eml"                         ; RETURN "message/rfc822"
   ...
   ELSEIF cFile LIKE ".+\.es3"                         ; RETURN "application/vnd.eszigno3+xml"
   ELSEIF cFile LIKE ".+\.esf"                         ; RETURN "application/vnd.epson.esf"
   ELSEIF cFile LIKE ".+\.es"                          ; RETURN "audio/echospeech"
 //ELSEIF cFile LIKE ".+\.es"                          ; RETURN "application/ecmascript"
   ELSEIF cFile LIKE ".+\.etf"                         ; RETURN "image/x-etf"
   ELSEIF cFile LIKE ".+\.etx"                         ; RETURN "text/x-setext"
   ELSEIF cFile LIKE ".+\.evy"                         ; RETURN "application/x-envoy"
   ELSEIF cFile LIKE ".+\.exe"                         ; RETURN "application/exe"
 //ELSEIF cFile LIKE ".+\.exe"                         ; RETURN "application/x-msdownload"
   ELSEIF cFile LIKE ".+\.exi"                         ; RETURN "application/exi"
   ...
   ELSEIF cFile LIKE ".+\.fcs"                         ; RETURN "application/vnd.isac.fcs"
   ...
   ELSEIF cFile LIKE ".+\.fh"                          ; RETURN "image/x-freehand"
   ELSEIF cFile LIKE ".+\.fif"                         ; RETURN "image/fif"
   ...
   ELSEIF cFile LIKE ".+\.fm"                          ; RETURN "application/vnd.framemaker"
   ELSEIF cFile LIKE ".+\.fnc"                         ; RETURN "application/vnd.frogans.fnc"
   ELSEIF cFile LIKE ".+\.fpx"                         ; RETURN "image/vnd.fpx"
   ELSEIF cFile LIKE ".+\.fpx"                         ; RETURN "image/x-fpx"
   ELSEIF cFile LIKE ".+\.frl"                         ; RETURN "application/freeloader"
   ...
   ELSEIF cFile LIKE ".+\.fxp"                         ; RETURN "application/vnd.adobe.fxp"
   ELSEIF cFile LIKE ".+\.fzs"                         ; RETURN "application/vnd.fuzzysheet"
   ELSEIF cFile LIKE ".+\.f"                           ; RETURN "text/x-fortran"
   ELSEIF cFile LIKE ".+\.g2w"                         ; RETURN "application/vnd.geoplan"
   ELSEIF cFile LIKE ".+\.g3"                          ; RETURN "image/g3fax"
   ELSEIF cFile LIKE ".+\.g3w"                         ; RETURN "application/vnd.geospace"
   ...
   ELSEIF cFile LIKE ".+\.gex"                         ; RETURN "application/vnd.geometry-explorer"
   ...
   ELSEIF cFile LIKE ".+\.gqf"                         ; RETURN "application/vnd.grafeq"
   ...
   ELSEIF cFile LIKE ".+\.html"                        ; RETURN "text/html"
   ...
   ELSEIF cFile LIKE ".+\.i2g"                         ; RETURN "application/vnd.intergeo"
   ELSEIF cFile LIKE ".+\.ica"                         ; RETURN "application/x-ica"
   ELSEIF cFile LIKE ".+\.icc"                         ; RETURN "application/vnd.iccprofile"
   ELSEIF cFile LIKE ".+\.ice"                         ; RETURN "x-conference/x-cooltalk"
   ELSEIF cFile LIKE ".+\.ico"                         ; RETURN "image/x-icon"
   ELSEIF cFile LIKE ".+\.ics"                         ; RETURN "text/calendar"
   ...
   ELSEIF cFile LIKE ".+\.igm"                         ; RETURN "application/vnd.insors.igm"
   ELSEIF cFile LIKE ".+\.igs"                         ; RETURN "model/iges"
   ...
   ELSEIF cFile LIKE ".+\.ins"                         ; RETURN "application/x-NET-Install"
   ELSEIF cFile LIKE ".+\.ipfix"                       ; RETURN "application/ipfix"
   ELSEIF cFile LIKE ".+\.ipk"                         ; RETURN "application/vnd.shana.informed.package"
   ELSEIF cFile LIKE ".+\.ips"                         ; RETURN "application/ips"
 //ELSEIF cFile LIKE ".+\.ips"                         ; RETURN "application/x-ipscript"
   ELSEIF cFile LIKE ".+\.ipx"                         ; RETURN "application/x-ipix"
   ...
   ELSEIF cFile LIKE ".+\.ivr"                         ; RETURN "i-world/i-vrml"
   ...
   ELSEIF cFile LIKE ".+\.jpm"                         ; RETURN "video/jpm"
   ELSEIF cFile LIKE ".+\.json"                        ; RETURN "application/json"
   ELSEIF cFile LIKE ".+\.js"                          ; RETURN "application/x-javascript"
 //ELSEIF cFile LIKE ".+\.js"                          ; RETURN "application/javascript"
   ...
   ELSEIF cFile LIKE ".+\.kne"                         ; RETURN "application/vnd.kinar"
   ELSEIF cFile LIKE ".+\.kon"                         ; RETURN "application/vnd.kde.kontour"
   ELSEIF cFile LIKE ".+\.kpr"                         ; RETURN "application/vnd.kde.kpresenter"
   ELSEIF cFile LIKE ".+\.ksp"                         ; RETURN "application/vnd.kde.kspread"
   ELSEIF cFile LIKE ".+\.ktx"                         ; RETURN "image/ktx"
   ELSEIF cFile LIKE ".+\.ktz"                         ; RETURN "application/vnd.kahootz"
   ELSEIF cFile LIKE ".+\.kwd"                         ; RETURN "application/vnd.kde.kword"
   ELSEIF cFile LIKE ".+\.lasxml"                      ; RETURN "application/vnd.las.las+xml"
   ...
   ELSEIF cFile LIKE ".+\.m21"                         ; RETURN "application/mp21"
   ELSEIF cFile LIKE ".+\.m3u"                         ; RETURN "audio/x-mpegurl"
   ELSEIF cFile LIKE ".+\.m3u8"                        ; RETURN "application/vnd.apple.mpegurl"
   ELSEIF cFile LIKE ".+\.m4v"                         ; RETURN "video/x-m4v"
   ELSEIF cFile LIKE ".+\.mads"                        ; RETURN "application/mads+xml"
   ELSEIF cFile LIKE ".+\.mag"                         ; RETURN "application/vnd.ecowin.chart"
   ELSEIF cFile LIKE ".+\.man"                         ; RETURN "application/x-troff-man"
   ELSEIF cFile LIKE ".+\.map"                         ; RETURN "application/x-httpd-imap"
   ELSEIF cFile LIKE ".+\.mathml"                      ; RETURN "application/mathml+xml"
   ELSEIF cFile LIKE ".+\.ma"                          ; RETURN "application/mathematica"
   ELSEIF cFile LIKE ".+\.mbd"                         ; RETURN "application/mbedlet"
   ...
   ELSEIF cFile LIKE ".+\.mcf"                         ; RETURN "image/vasa"
   ...
   ELSEIF cFile LIKE ".+\.meta4"                       ; RETURN "application/metalink4+xml"
   ELSEIF cFile LIKE ".+\.mets"                        ; RETURN "application/mets+xml"
   ELSEIF cFile LIKE ".+\.me"                          ; RETURN "application/x-troff-me"
   ELSEIF cFile LIKE ".+\.mfm"                         ; RETURN "application/vnd.mfmp"
   ELSEIF cFile LIKE ".+\.mfp"                         ; RETURN "application/mirage"
   ELSEIF cFile LIKE ".+\.mgp"                         ; RETURN "application/vnd.osgeo.mapguide.package"
   ELSEIF cFile LIKE ".+\.mgz"                         ; RETURN "application/vnd.proteus.magazine"
   ELSEIF cFile LIKE ".+\.mid"                         ; RETURN "audio/midi"
   ELSEIF cFile LIKE ".+\.mif"                         ; RETURN "application/x-mif"
 //ELSEIF cFile LIKE ".+\.mif"                         ; RETURN "application/vnd.mif"
   ELSEIF cFile LIKE ".+\.mj2"                         ; RETURN "video/mj2"
   ...
   ELSEIF cFile LIKE ".+\.mods"                        ; RETURN "application/mods+xml"
   ELSEIF cFile LIKE ".+\.mol"                         ; RETURN "chemical/x-mdl-molfile"
   ELSEIF cFile LIKE ".+\.movie"                       ; RETURN "video/x-sgi-movie"
   ELSEIF cFile LIKE ".+\.mp2"                         ; RETURN "audio/x-mpeg"
   ELSEIF cFile LIKE ".+\.mp3"                         ; RETURN "audio/x-mpeg"
   ELSEIF cFile LIKE ".+\.mp4"                         ; RETURN "video/mp4"
 //ELSEIF cFile LIKE ".+\.mp4"                         ; RETURN "application/mp4"
   ELSEIF cFile LIKE ".+\.mp4a"                        ; RETURN "audio/mp4"
   ELSEIF cFile LIKE ".+\.mpc"                         ; RETURN "application/vnd.mophun.certificate"
   ELSEIF cFile LIKE ".+\.mpeg"                        ; RETURN "video/mpeg"
   ELSEIF cFile LIKE ".+\.mpga"                        ; RETURN "audio/mpeg"
   ...
   ELSEIF cFile LIKE ".+\.mpp"                         ; RETURN "application/vnd.ms-project"
   ...
   ELSEIF cFile LIKE ".+\.mrcx"                        ; RETURN "application/marcxml+xml"
   ...
   ELSEIF cFile LIKE ".+\.mvb"                         ; RETURN "application/x-msmediaview"
   ...
   ELSEIF cFile LIKE ".+\.mxml"                        ; RETURN "application/xv+xml"
   ELSEIF cFile LIKE ".+\.mxs"                         ; RETURN "application/vnd.triscape.mxs"
   ELSEIF cFile LIKE ".+\.mxu"                         ; RETURN "video/vnd.mpegurl"
   ELSEIF cFile LIKE ".+\.n-gage"                      ; RETURN "application/vnd.nokia.n-gage.symbian.install"
   ELSEIF cFile LIKE ".+\.n2p"                         ; RETURN "application/n2p"
   ELSEIF cFile LIKE ".+\.n3"                          ; RETURN "text/n3"
   ELSEIF cFile LIKE ".+\.nbp"                         ; RETURN "application/vnd.wolfram.player"
   ELSEIF cFile LIKE ".+\.nc"                          ; RETURN "application/x-netcdf"
   ...
   ELSEIF cFile LIKE ".+\.npx"                         ; RETURN "application/x-netfpx"
   ELSEIF cFile LIKE ".+\.npx"                         ; RETURN "image/vnd.net-fpx"
   ELSEIF cFile LIKE ".+\.nsc"                         ; RETURN "application/x-nschat"
   ...
   ELSEIF cFile LIKE ".+\.odm"                         ; RETURN "application/vnd.oasis.opendocument.text-master"
   ...
   ELSEIF cFile LIKE ".+\.oga"                         ; RETURN "audio/ogg"
   ELSEIF cFile LIKE ".+\.ogv"                         ; RETURN "video/ogg"
   ELSEIF cFile LIKE ".+\.ogx"                         ; RETURN "application/ogg"
   ELSEIF cFile LIKE ".+\.onetoc"                      ; RETURN "application/onenote"
   ...
   ELSEIF cFile LIKE ".+\.p12"                         ; RETURN "application/x-pkcs12"
   ELSEIF cFile LIKE ".+\.p7b"                         ; RETURN "application/x-pkcs7-certificates"
   ELSEIF cFile LIKE ".+\.p7m"                         ; RETURN "application/pkcs7-mime"
   ELSEIF cFile LIKE ".+\.p7r"                         ; RETURN "application/x-pkcs7-certreqresp"
   ELSEIF cFile LIKE ".+\.p7s"                         ; RETURN "application/pkcs7-signature"
   ELSEIF cFile LIKE ".+\.p8"                          ; RETURN "application/pkcs8"
   ELSEIF cFile LIKE ".+\.par"                         ; RETURN "text/plain-bas"
   ELSEIF cFile LIKE ".+\.paw"                         ; RETURN "application/vnd.pawaafile"
   ...
   ELSEIF cFile LIKE ".+\.pdb"                         ; RETURN "chemical/x-pdb"
 //ELSEIF cFile LIKE ".+\.pdb"                         ; RETURN "application/vnd.palm"
   ELSEIF cFile LIKE ".+\.pdf"                         ; RETURN "application/pdf"
   ELSEIF cFile LIKE ".+\.pfa"                         ; RETURN "application/x-font-type1"
   ...
   ELSEIF cFile LIKE ".+\.pgp"                         ; RETURN "application/x-pgp-plugin"
 //ELSEIF cFile LIKE ".+\.pgp"                         ; RETURN "application/pgp-signature"
   ELSEIF cFile LIKE ".+\.pgr"                         ; RETURN "text/parsnegar-document"
   ELSEIF cFile LIKE ".+\.php3"                        ; RETURN "application/x-httpd-php3"
   ELSEIF cFile LIKE ".+\.phtml"                       ; RETURN "application/x-httpd-php"
   ELSEIF cFile LIKE ".+\.pic"                         ; RETURN "image/x-pict"
   ...
   ELSEIF cFile LIKE ".+\.ppt"                         ; RETURN "application/vnd.ms-powerpoint"
   ...
   ELSEIF cFile LIKE ".+\.pqf"                         ; RETURN "application/x-cprplayer"
   ELSEIF cFile LIKE ".+\.pqi"                         ; RETURN "application/cprplayer"
   ELSEIF cFile LIKE ".+\.prc"                         ; RETURN "application/x-mobipocket-ebook"
   ...
   ELSEIF cFile LIKE ".+\.pskcxml"                     ; RETURN "application/pskc+xml"
   ELSEIF cFile LIKE ".+\.ptid"                        ; RETURN "application/vnd.pvi.ptid1"
   ELSEIF cFile LIKE ".+\.ptlk"                        ; RETURN "application/listenup"
   ELSEIF cFile LIKE ".+\.pub"                         ; RETURN "application/x-mspublisher"
   ELSEIF cFile LIKE ".+\.push"                        ; RETURN "multipart/x-mixed-replace"
   ...
   ELSEIF cFile LIKE ".+\.p"                           ; RETURN "text/x-pascal"
   ...
   ELSEIF cFile LIKE ".+\.qrt"                         ; RETURN "application/quest"
   ELSEIF cFile LIKE ".+\.qt"                          ; RETURN "video/quicktime"
   ELSEIF cFile LIKE ".+\.qxd"                         ; RETURN "application/vnd.quark.quarkxpress"
   ELSEIF cFile LIKE ".+\.ram"                         ; RETURN "audio/x-pn-realaudio"
   ...
   ELSEIF cFile LIKE ".+\.rip"                         ; RETURN "image/rip"
 //ELSEIF cFile LIKE ".+\.rip"                         ; RETURN "audio/vnd.rip"
   ...
   ELSEIF cFile LIKE ".+\.rmf"                         ; RETURN "audio/rmf"
 //ELSEIF cFile LIKE ".+\.rmf"                         ; RETURN "audio/x-rmf"
   ...
   ELSEIF cFile LIKE ".+\.rp9"                         ; RETURN "application/vnd.cloanto.rp9"
   ELSEIF cFile LIKE ".+\.rpm"                         ; RETURN "audio/x-pn-realaudio-plugin"
   ...
   ELSEIF cFile LIKE ".+\.rrf"                         ; RETURN "application/x-InstallFromTheWeb"
   ...
   ELSEIF cFile LIKE ".+\.rtc"                         ; RETURN "application/rtc"
   ...
   ELSEIF cFile LIKE ".+\.sca"                         ; RETURN "application/x-supercard"
   ...
   ELSEIF cFile LIKE ".+\.sdkm"                        ; RETURN "application/vnd.solent.sdkm+xml"
   ELSEIF cFile LIKE ".+\.sdp"                         ; RETURN "application/sdp"
   ELSEIF cFile LIKE ".+\.sdw"                         ; RETURN "application/vnd.stardivision.writer"
   ELSEIF cFile LIKE ".+\.seed"                        ; RETURN "application/vnd.fdsn.seed"
   ...
   ELSEIF cFile LIKE ".+\.smi"                         ; RETURN "application/smil+xml"
   ELSEIF cFile LIKE ".+\.smp"                         ; RETURN "application/studiom"
   ELSEIF cFile LIKE ".+\.sm"                          ; RETURN "application/vnd.stepmania.stepchart"
   ELSEIF cFile LIKE ".+\.snf"                         ; RETURN "application/x-font-snf"
   ELSEIF cFile LIKE ".+\.spf"                         ; RETURN "application/vnd.yamaha.smaf-phrase"
   ELSEIF cFile LIKE ".+\.spl"                         ; RETURN "application/futuresplash"
 //ELSEIF cFile LIKE ".+\.spl"                         ; RETURN "application/x-futuresplash"
   ...
   ELSEIF cFile LIKE ".+\.sprite"                      ; RETURN "application/x-sprite"
   ELSEIF cFile LIKE ".+\.spr"                         ; RETURN "application/x-sprite"
   ELSEIF cFile LIKE ".+\.src"                         ; RETURN "application/x-wais-source"
   ELSEIF cFile LIKE ".+\.sru"                         ; RETURN "application/sru+xml"
 ...
 //ELSEIF cFile LIKE ".+\.stk"                         ; RETURN "application/hyperstudio"
   ...
   ELSEIF cFile LIKE ".+\.st"                          ; RETURN "application/vnd.sailingtracker.track"
   ELSEIF cFile LIKE ".+\.sub"                         ; RETURN "image/vnd.dvb.subtitle"
   ELSEIF cFile LIKE ".+\.sus"                         ; RETURN "application/vnd.sus-calendar"
   ELSEIF cFile LIKE ".+\.sv4cpio"                     ; RETURN "application/x-sv4cpio"
   ELSEIF cFile LIKE ".+\.sv4crc"                      ; RETURN "application/x-sv4crc"
   ELSEIF cFile LIKE ".+\.svc"                         ; RETURN "application/vnd.dvb.service"
   ELSEIF cFile LIKE ".+\.svd"                         ; RETURN "application/vnd.svd"
   ELSEIF cFile LIKE ".+\.svg"                         ; RETURN "image/svg+xml"
   ELSEIF cFile LIKE ".+\.svh"                         ; RETURN "image/svh"
   ELSEIF cFile LIKE ".+\.svr"                         ; RETURN "x-world/x-svr"
   ELSEIF cFile LIKE ".+\.swf"                         ; RETURN "application/x-shockwave-flash"
   ELSEIF cFile LIKE ".+\.swi"                         ; RETURN "application/vnd.aristanetworks.swi"
   ...
   ELSEIF cFile LIKE ".+\.s"                           ; RETURN "text/x-asm"
   ELSEIF cFile LIKE ".+\.talk"                        ; RETURN "application/talker"
   ELSEIF cFile LIKE ".+\.tao"                         ; RETURN "application/vnd.tao.intent-module-archive"
   ELSEIF cFile LIKE ".+\.tar"                         ; RETURN "application/x-tar"
   ELSEIF cFile LIKE ".+\.tbk"                         ; RETURN "application/toolbook"
   ...
   ELSEIF cFile LIKE ".+\.tei"                         ; RETURN "application/tei+xml"
   ELSEIF cFile LIKE ".+\.texinfo"                     ; RETURN "application/x-texinfo"
   ELSEIF cFile LIKE ".+\.tex"                         ; RETURN "application/x-tex"
   ELSEIF cFile LIKE ".+\.tfi"                         ; RETURN "application/thraud+xml"
   ELSEIF cFile LIKE ".+\.tfm"                         ; RETURN "application/x-tex-tfm"
   ELSEIF cFile LIKE ".+\.thmx"                        ; RETURN "application/vnd.ms-officetheme"
   ELSEIF cFile LIKE ".+\.tiff"                        ; RETURN "image/tiff"
   ELSEIF cFile LIKE ".+\.tlk"                         ; RETURN "application/x-tlk"
   ELSEIF cFile LIKE ".+\.tmo"                         ; RETURN "application/vnd.tmobile-livetv"
   ELSEIF cFile LIKE ".+\.tmv"                         ; RETURN "application/x-Parable-Thing"
   ...
   ELSEIF cFile LIKE ".+\.tsd"                         ; RETURN "application/timestamped-data"
   ELSEIF cFile LIKE ".+\.tsi"                         ; RETURN "audio/tsplayer"
   ELSEIF cFile LIKE ".+\.tsp"                         ; RETURN "application/dsptype"
   ELSEIF cFile LIKE ".+\.tsv"                         ; RETURN "text/tab-separated-values"
   ELSEIF cFile LIKE ".+\.ttf"                         ; RETURN "application/x-font-ttf"
   ELSEIF cFile LIKE ".+\.ttl"                         ; RETURN "text/turtle"
   ELSEIF cFile LIKE ".+\.twd"                         ; RETURN "application/vnd.simtech-mindmapper"
   ELSEIF cFile LIKE ".+\.txd"                         ; RETURN "application/vnd.genomatix.tuxedo"
   ELSEIF cFile LIKE ".+\.txf"                         ; RETURN "application/vnd.mobius.txf"
   ELSEIF cFile LIKE ".+\.txt"                         ; RETURN "text/plain"
   ELSEIF cFile LIKE ".+\.t"                           ; RETURN "text/troff"
   ELSEIF cFile LIKE ".+\.ufd"                         ; RETURN "application/vnd.ufdl"
   ...
   ELSEIF cFile LIKE ".+\.uri"                         ; RETURN "text/uri-list"
   ...
   ELSEIF cFile LIKE ".+\.uva"                         ; RETURN "audio/vnd.dece.audio"
   ELSEIF cFile LIKE ".+\.uvh"                         ; RETURN "video/vnd.dece.hd"
   ELSEIF cFile LIKE ".+\.uvi"                         ; RETURN "image/vnd.dece.graphic"
   ELSEIF cFile LIKE ".+\.uvm"                         ; RETURN "video/vnd.dece.mobile"
   ELSEIF cFile LIKE ".+\.uvp"                         ; RETURN "video/vnd.dece.pd"
   ELSEIF cFile LIKE ".+\.uvs"                         ; RETURN "video/vnd.dece.sd"
   ELSEIF cFile LIKE ".+\.uvu"                         ; RETURN "video/vnd.uvvu.mp4"
   ELSEIF cFile LIKE ".+\.uvv"                         ; RETURN "video/vnd.dece.video"
   ELSEIF cFile LIKE ".+\.vbd"                         ; RETURN "application/activexdocument"
   ...
   ELSEIF cFile LIKE ".+\.vgp"                         ; RETURN "video/x-videogram-plugin"
   ELSEIF cFile LIKE ".+\.vis"                         ; RETURN "application/vnd.visionary"
   ELSEIF cFile LIKE ".+\.viv"                         ; RETURN "video/vnd.vivo"
   ELSEIF cFile LIKE ".+\.vmd"                         ; RETURN "application/vocaltec-media-desc"
   ELSEIF cFile LIKE ".+\.vmf"                         ; RETURN "application/vocaltec-media-file"
   ELSEIF cFile LIKE ".+\.vox"                         ; RETURN "audio/voxware"
   ELSEIF cFile LIKE ".+\.vqe"                         ; RETURN "audio/x-twinvq-plugin"
   ELSEIF cFile LIKE ".+\.vrt"                         ; RETURN "x-world/x-vrt"
   ELSEIF cFile LIKE ".+\.vsd"                         ; RETURN "application/vnd.visio"
   ELSEIF cFile LIKE ".+\.vsf"                         ; RETURN "application/vnd.vsf"
   ELSEIF cFile LIKE ".+\.vts"                         ; RETURN "workbook/formulaone"
   ELSEIF cFile LIKE ".+\.vtts"                        ; RETURN "workbook/formulaone"
   ...
   ELSEIF cFile LIKE ".+\.weba"                        ; RETURN "audio/webm"
   ELSEIF cFile LIKE ".+\.webm"                        ; RETURN "video/webm"
   ELSEIF cFile LIKE ".+\.webp"                        ; RETURN "image/webp"
   ELSEIF cFile LIKE ".+\.wgt"                         ; RETURN "application/widget"
   ELSEIF cFile LIKE ".+\.wg"                          ; RETURN "application/vnd.pmi.widget"
   ELSEIF cFile LIKE ".+\.wid"                         ; RETURN "application/x-DemoShield"
   ELSEIF cFile LIKE ".+\.wis"                         ; RETURN "application/x-InstallShield"
   ELSEIF cFile LIKE ".+\.wi"                          ; RETURN "image/wavelet"
   ELSEIF cFile LIKE ".+\.wlt"                         ; RETURN "application/x-mswallet"
 ...
 //ELSEIF cFile LIKE ".+\.wri"                         ; RETURN "application/x-mswrite"
   ...
   ELSEIF cFile LIKE ".+\.wtx"                         ; RETURN "audio/wtx"
 //ELSEIF cFile LIKE ".+\.wtx"                         ; RETURN "audio/x-wtx"
   ...
   ELSEIF cFile LIKE ".+\.xhtml"                       ; RETURN "application/xhtml+xml"
   ELSEIF cFile LIKE ".+\.xif"                         ; RETURN "image/vnd.xiff"
   ELSEIF cFile LIKE ".+\.xlam"                        ; RETURN "application/vnd.ms-excel.addin.macroenabled.12"
   ELSEIF cFile LIKE ".+\.xls"                         ; RETURN "application/xls"
 //ELSEIF cFile LIKE ".+\.xls"                         ; RETURN "application/vnd.ms-excel"
   ...
   ELSEIF cFile LIKE ".+\.xlt"                         ; RETURN "application/xlt"
   ELSEIF cFile LIKE ".+\.xml"                         ; RETURN "application/xml"
   ...
   ELSEIF cFile LIKE ".+\.xpw"                         ; RETURN "application/vnd.intercon.formnet"
   ...
   ELSEIF cFile LIKE ".+\.yang"                        ; RETURN "application/yang"
   ELSEIF cFile LIKE ".+\.yin"                         ; RETURN "application/yin+xml"
   ELSEIF cFile LIKE ".+\.zaz"                         ; RETURN "application/vnd.zzazz.deck+xml"
   ELSEIF cFile LIKE ".+\.zip"                         ; RETURN "application/zip"
   ELSEIF cFile LIKE ".+\.zir"                         ; RETURN "application/vnd.zul"
   ELSEIF cFile LIKE ".+\.zmm"                         ; RETURN "application/vnd.handheld-entertainment+xml"
   ELSEIF cFile LIKE ".+\.zpa"                         ; RETURN "application/pcphoto"
