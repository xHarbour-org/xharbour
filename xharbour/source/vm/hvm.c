...
void HB_EXPORT hb_vmExecute( register const BYTE * pCode, register PHB_SYMB pSymbols )
{
   ...
   LONG w = 0;
   LONG lNextSection /*= 0*/; 
   LONG lCatchSection = 0;
   LONG lFinallySection = 0;
...
static void hb_vmPlus( PHB_ITEM pLeft, PHB_ITEM pRight, PHB_ITEM pResult )
{
   ...
   else if( HB_IS_NUMERIC( pLeft ) && HB_IS_NUMERIC( pRight ) )
   {
      ...
      int iDec1 = 0;
	  int iDec2 = 0;
	  int iType1 = pLeft->type;
	  int iType2 = pRight->type;
...
static void hb_vmMult( void )
{
   ...
   if( HB_IS_NUMERIC( pItem1 ) && HB_IS_NUMERIC( pItem2 ) )
   {
      ...
      int iDec2 = 0;
	  int iDec1 = 0;
	  int iType2 = pItem2->type;
	  int iType1 = pItem1->type;
...
static void hb_vmBitAnd( void )
{
   ...
   else if( HB_IS_STRING( pItem1 ) &&  HB_IS_STRING( pItem2 ) )
   {
      ...
      if( ulLen1 && ulLen2 )
      {
         ...
         register ULONG ulPos1 = 0;
		 register ULONG ulPos2 = 0;
...
static void hb_vmPushBlock( const BYTE * pCode, USHORT usSize, BOOL bDynCode )
{
   HB_THREAD_STUB
   PHB_ITEM pTop = NULL;
   BYTE * pBlockCode = NULL;
   BYTE * pBlockTemp = NULL;
   USHORT uiLocals = 0;
...
PSYMBOLS hb_vmRegisterSymbols( PHB_SYMB pSymbolTable, USHORT uiSymbols, char * szModuleName, BOOL fDynLib, BOOL fClone, PHB_ITEM *pGlobals )
{
   ...
   HB_SYMBOLSCOPE hSymScope = NULL;
   USHORT ui = 0;
   BOOL fRecycled = FALSE;
   ...
   if ( pBlockAsArray && ( hb_arrayLen( pBlockAsArray ) == 4 || hb_arrayLen( pBlockAsArray ) == 7 ) )
   {
      ...
      if( HB_IS_STRING( &ModuleName ) && HB_IS_STRING( &PCode ) && HB_IS_INTEGER( &ParamCount ) && HB_IS_INTEGER( &ClassH ) )
      {
         ...
         if( HB_IS_STRING( &ProcName ) && HB_IS_INTEGER( &ProcLine ) && HB_IS_INTEGER( &iStatics ) )
         {
            ...
            Block.item.asBlock.value->lineno = ProcLine.item.asInteger.value;
