/*
 * $Id: pptable.c,v 1.51 2005/02/27 05:52:00 ronpinkas Exp $
 */
...
void hb_pp_Table( void )
{
   ...
   */
   ...
   static COMMANDS sC___134 = {0,"RESTORE","\16FROM \1A40\17 \16\1B20 ADDITIVE>\17","__MVRestore( \1A30, \1B50 )",&sC___133 };
   ...
   static COMMANDS sC___139 = {0,"SAVE","\16TO \1A40\17 \16ALL\17","__MVSave( \1A30, '*', .t. )",&sC___138 };
   ...
   static COMMANDS sC___200 = {0,"CREATE","\1A40 \16FROM \1B40\17 \16VIA \1C00\17 \16ALIAS \1D00\17 \16\1E20 NEW>\17 \16CODEPAGE \1F00\17",
   ...
   static COMMANDS sC___203 = {0,"COPY","\16TO \1A40\17 \16DELIMITED \16WITH \1B30\17\17 \16FIELDS \1C10\17 \16FOR \1D00\17 \16WHILE \1E00\17 \16NEXT \1F00\17 \16RECORD \1G00\17 \16\1H20REST>\17 \16ALL\17",
       "__dbDelim( .T., \1A30, \1B30, { \1C30 }, \1D40, \1E40, \1F00, \1G00, \1H50 )",&sC___202 };
   static COMMANDS sC___204 = {0,"COPY","\16TO \1A40\17 \16SDF\17 \16FIELDS \1B10\17 \16FOR \1C00\17 \16WHILE \1D00\17 \16NEXT \1E00\17 \16RECORD \1F00\17 \16\1G20REST>\17 \16ALL\17",
       "__dbSDF( .T., \1A30, { \1B30 }, \1C40, \1D40, \1E00, \1F00, \1G50 )",&sC___203 };
   static COMMANDS sC___205 = {0,"COPY","\16TO \1A40\17 \16FIELDS \1B10\17 \16FOR \1C00\17 \16WHILE \1D00\17 \16NEXT \1E00\17 \16RECORD \1F00\17 \16\1G20REST>\17 \16VIA \1H00\17 \16ALL\17",
       "__dbCopy( \1A30, { \1B30 }, \1C40, \1D40, \1E00, \1F00, \1G50, \1H00 )",&sC___204 };
   static COMMANDS sC___206 = {0,"APPEND","\16FROM \1A40\17 \16DELIMITED \16WITH \1B30\17\17 \16FIELDS \1C10\17 \16FOR \1D00\17 \16WHILE \1E00\17 \16NEXT \1F00\17 \16RECORD \1G00\17 \16\1H20REST>\17 \16ALL\17",
       "__dbDelim( .F., \1A30, \1B30, { \1C30 }, \1D40, \1E40, \1F00, \1G00, \1H50 )",&sC___205 };
   static COMMANDS sC___207 = {0,"APPEND","\16FROM \1A40\17 \16SDF\17 \16FIELDS \1B10\17 \16FOR \1C00\17 \16WHILE \1D00\17 \16NEXT \1E00\17 \16RECORD \1F00\17 \16\1G20REST>\17 \16ALL\17",
       "__dbSDF( .F., \1A30, { \1B30 }, \1C40, \1D40, \1E00, \1F00, \1G50 )",&sC___206 };
   static COMMANDS sC___208 = {0,"APPEND","\16FROM \1A40\17 \16FIELDS \1B10\17 \16FOR \1C00\17 \16WHILE \1D00\17 \16NEXT \1E00\17 \16RECORD \1F00\17 \16\1G20REST>\17 \16VIA \1H00\17 \16ALL\17",
       "__dbApp( \1A30, { \1B30 }, \1C40, \1D40, \1E00, \1F00, \1G50, \1H00 )",&sC___207 };
   static COMMANDS sC___209 = {0,"SORT","\16TO \1A40\17 \16ON \1B10\17 \16FOR \1C00\17 \16WHILE \1D00\17 \16NEXT \1E00\17 \16RECORD \1F00\17 \16\1G20REST>\17 \16ALL\17",
       "__dbSort( \1A30, { \1B30 }, \1C40, \1D40, \1E00, \1F00, \1G50 )",&sC___208 };
   static COMMANDS sC___210 = {0,"TOTAL","\16TO \1A40\17 \16ON \1B00\17 \16FIELDS \1C10\17 \16FOR \1D00\17 \16WHILE \1E00\17 \16NEXT \1F00\17 \16RECORD \1G00\17 \16\1H20REST>\17 \16ALL\17",
   ...
   static COMMANDS sC___212 = {0,"JOIN","\16WITH \1A40\17 \16TO \1B00\17 \16FIELDS \1C10\17 \16FOR \1D00\17",
...
#ifdef HB_EXTENSION
   static COMMANDS sC___230 = {0,"INDEX","ON \1A00 \16TAG \1B40 \17 TO \1C40 \16FOR \1D00\17 \16\1E20ALL>\17 \16WHILE \1F00\17 \16NEXT \1G00\17 \16RECORD \1H00\17 \16\1I20REST>\17 \16EVAL \1J00\17 \16EVERY \1K00\17 \16\1L20 UNIQUE>\17 \16\1M20 ASCENDING>\17 \16\1N20 DESCENDING>\17 \16\1O20 USECURRENT>\17 \16\1P20 ADDITIVE>\17 \16\1R20 CUSTOM>\17 \16\1S20 NOOPTIMIZE>\17 \16\1T20 MEMORY>\17",
       "ordCondSet( \1D20, \1D40, \16\1E50\17, \1F40, \1J40, \1K00, RECNO(), \1G00, \1H00, \16\1I50\17, \16\1N50\17,, \16\1P50\17, \16\1O50\17, \16\1R50\17, \16\1S50\17, \1F20, \16\1T50\17 ) ;  ordCreate(\1C30, \1B30, \1A20, \1A40, \16\1L50\17 )",&sC___229 };
   static COMMANDS sC___231 = {0,"INDEX","ON \1A00 TAG \1B40 \16TO \1C40\17 \16FOR \1D00\17 \16\1E20ALL>\17 \16WHILE \1F00\17 \16NEXT \1G00\17 \16RECORD \1H00\17 \16\1I20REST>\17 \16EVAL \1J00\17 \16EVERY \1K00\17 \16\1L20 UNIQUE>\17 \16\1M20 ASCENDING>\17 \16\1N20 DESCENDING>\17 \16\1O20 USECURRENT>\17 \16\1P20 ADDITIVE>\17 \16\1R20 CUSTOM>\17 \16\1S20 NOOPTIMIZE>\17 \16\1T20 MEMORY>\17",
       "ordCondSet( \1D20, \1D40, \16\1E50\17, \1F40, \1J40, \1K00, RECNO(), \1G00, \1H00, \16\1I50\17, \16\1N50\17,, \16\1P50\17, \16\1O50\17, \16\1R50\17, \16\1S50\17, \1F20, \16\1T50\17 ) ;  ordCreate(\1C30, \1B30, \1A20, \1A40, \16\1L50\17 )",&sC___230 };
#else
   ...
   static COMMANDS sC___236 = {0,"SET","INDEX TO \16 \1A40 \16, \1B40\17\17 \16\1C20 ADDITIVE>\17",
       "if !\1C50 ; ordListClear() ; end \16; ordListAdd( \1A30 )\17 \16; ordListAdd( \1B30 )\17",&sC___235 };
   static COMMANDS sC___237 = {0,"SET","ORDER TO \1A00 \16IN \1B40\17","ordSetFocus( \1A00 \16, \1B30\17 )",&sC___236 };
   static COMMANDS sC___238 = {0,"SET","ORDER TO TAG \1A40 \16IN \1B40\17","ordSetFocus( \1A30 \16, \1B30\17 )",&sC___237 };
   ...
   static COMMANDS sC___253 = {0,"SET","ERRORLOOP TO \1A00","Set(_SET_ERRORLOOP, \1A00 )",&sC___252 };
   static COMMANDS sC___254 = {0,"SET","ERRORLOOP TO","Set(_SET_ERRORLOOP, 0 )",&sC___253 };
   static COMMANDS sC___255 = {0,"SET","DBFLOCKSCHEME TO \1A00","Set(_SET_DBFLOCKSCHEME, \1A00 )",&sC___254 };
   static COMMANDS sC___256 = {0,"SET","DBFLOCKSCHEME TO","Set(_SET_DBFLOCKSCHEME, 0 )",&sC___255 };
   static COMMANDS sC___257 = {0,"SET","ERRORLOG TO \1A40 \16\1B20 ADDITIVE>\17","Set( _SET_ERRORLOG, \1A30, \1B50 )",&sC___256 };
   ...
   static COMMANDS sC___258 = {0,"@","\1A00,\1B00 GET \1C00 CHECKBOX \16VALID \1D00\17 \16WHEN \1E00\17 \16CAPTION \1F00\17 \16MESSAGE \1G00\17 \16COLOR \1H00\17 \16FOCUS \1I00\17 \16STATE \1J00\17 \16STYLE \1K00\17 \16SEND \1L00\17 \16GUISEND \1M00\17",
       "SetPos(\1A00,\1B00 ) ; AAdd(GetList,_GET_(\1C00,\1C30,NIL,\1D40,\1E40 ) ) ; ATail(GetList):Control := _CheckBox_(\1C00,\1F00,\1G00,\1H00,\1I40,\1J40,\1K00 ) ; ATail(GetList):reader := { | a,b,c,d | GuiReader(a,b,c,d ) } \16; ATail(GetList):\1L00\17 \16; ATail(GetList):Control:\1M00\17 ; ATail(GetList):Control:Display()",&sC___257 };
   static COMMANDS sC___259 = {0,"@","\1A00,\1B00,\1C00,\1D00 GET \1E00 RADIOGROUP \1F00 \16VALID \1G00\17 \16WHEN \1H00\17 \16CAPTION \1I00\17 \16MESSAGE \1J00\17 \16COLOR \1K00\17 \16FOCUS \1L00\17 \16STYLE \1M00\17 \16SEND \1N00\17 \16GUISEND \1O00\17",
       "SetPos(\1A00,\1B00 ) ; AAdd(GetList,_GET_(\1E00,\1E30,NIL,\1G40,\1H40 ) ) ; ATail(GetList):Control := _RadioGrp_(ATail(Getlist):row,ATail(Getlist):col,\1C00,\1D00,\1E00,\1F00,\1I00,\1J00,\1K00,\1L40,\1M00 ) ; ATail(GetList):reader := { | a,b,c,d | GuiReader(a,b,c,d ) } \16; ATail(GetList):\1N00\17 \16; ATail(GetList):Control:\1O00\17 ; ATail(GetList):Control:Display()",&sC___258 };
   static COMMANDS sC___260 = {0,"@","\1A00,\1B00 GET \1C00 PUSHBUTTON \16VALID \1D00\17 \16WHEN \1E00\17 \16CAPTION \1F00\17 \16MESSAGE \1G00\17 \16COLOR \1H00\17 \16FOCUS \1I00\17 \16STATE \1J00\17 \16STYLE \1K00\17 \16SEND \1L00\17 \16GUISEND \1M00\17",
       "SetPos(\1A00,\1B00 ) ; AAdd(GetList,_GET_(\1C00,\1C30,NIL,\1D40,\1E40 ) ) ; ATail(GetList):Control := _PushButt_(\1F00,\1G00,\1H00,\1I40,\1J40,\1K00,) ; ATail(GetList):reader := { | a,b,c,d | GuiReader(a,b,c,d ) } \16; ATail(GetList):\1L00\17 \16; ATail(GetList):Control:\1M00\17 ; ATail(GetList):Control:Display()",&sC___259 };
   static COMMANDS sC___261 = {0,"@","\1A00,\1B00,\1C00,\1D00 GET \1E00 LISTBOX \1F00 \16VALID \1G00\17 \16WHEN \1H00\17 \16CAPTION \1I00\17 \16MESSAGE \1J00\17 \16COLOR \1K00\17 \16FOCUS \1L00\17 \16STATE \1M00\17 \16\1N20  DROPDOWN>\17 \16\1O20  SCROLLBAR>\17 \16SEND \1P00\17 \16GUISEND \1Q00\17",
   ...
   static COMMANDS sC___262 = {0,"@","\1A00,\1B00,\1C00,\1D00 GET \1E00 TBROWSE \1F00 \16VALID \1G00\17 \16WHEN \1H00\17 \16MESSAGE \1I00\17 \16SEND \1J00\17 \16GUISEND \1K00\17",
       "SetPos(\1A00,\1B00 ) ; AAdd(GetList,_GET_(\1E00,\1E30,NIL,\1G40,\1H40 ) ) ; \1F00:ntop := ATail(Getlist):row ; \1F00:nleft := ATail(Getlist):col ; \1F00:nbottom := \1C00 ; \1F00:nright := \1D00 ; \1F00:Configure() ; ATail(GetList):Control := \1F00 ; ATail(GetList):reader := { | a,b,c,d | TBReader( a, b, c, d ) } \16; ATail(GetList):Control:Message := \1I00\17 \16; ATail(GetList):\1J00\17 \16; ATail(GetList):Control:\1K00\17",&sC___261 };
   static COMMANDS sC___263 = {0,"READ","\16MSG AT \1A00,\1B00,\1C00 \16MSG COLOR \1D00\17\17",
       "ReadModal(GetList,NIL,NIL,\1A00,\1B00,\1C00,\1D00 ) ; GetList := {}",&sC___262 };
   static COMMANDS sC___264 = {0,"@","\1A00,\1B00 GET \1C00 \16PICTURE \1D00\17 \16VALID \1E00\17 \16WHEN \1F00\17 \16CAPTION \1G00\17 \16MESSAGE \1H00\17 \16SEND \1I00\17",
       "SetPos(\1A00,\1B00 ) ; AAdd(GetList,_GET_(\1C00,\1C20,\1D00,\1E40,\1F40 ) ) \16; ATail(GetList):Caption := \1G00\17 \16; ATail(GetList):CapRow := ATail(Getlist):row ; ATail(GetList):CapCol := ATail(Getlist):col - __CapLength(\1G00) - 1\17 \16; ATail(GetList):message := \1H00\17 \16; ATail(GetList):\1I00\17 ; ATail(GetList):Display()",&sC___263 };
   static COMMANDS sC___265 = {0,"SET","MBLOCKSIZE TO \1A00","Set( _SET_MBLOCKSIZE, \1A00 )",&sC___264 };
   static COMMANDS sC___266 = {0,"SET","MEMOBLOCK TO \1A00","Set( _SET_MBLOCKSIZE, \1A00 )",&sC___265 };
   static COMMANDS sC___267 = {0,"SET","MFILEEXT TO \1A00","Set( _SET_MFILEEXT, \1A00 )",&sC___266 };
   static COMMANDS sC___268 = {0,"SET","AUTOSHARE TO \1A00","Set( _SET_AUTOSHARE, \1A00 )",&sC___267 };
   static COMMANDS sC___269 = {0,"SET","AUTOSHARE TO","Set( _SET_AUTOSHARE, 0 )",&sC___268 };
   static COMMANDS sC___270 = {0,"SET","AUTORDER TO \1A00","Set( _SET_AUTORDER, \1A00 )",&sC___269 };
   static COMMANDS sC___271 = {0,"SET","AUTORDER TO","Set( _SET_AUTORDER, 0 )",&sC___270 };
   static COMMANDS sC___272 = {0,"SET","STRICTREAD \1A20 ON,OFF,&>","Set(_SET_STRICTREAD,\1A30 )",&sC___271 };
   static COMMANDS sC___273 = {0,"SET","STRICTREAD (\1A00)","Set(_SET_STRICTREAD,\1A00 )",&sC___272 };
   static COMMANDS sC___274 = {0,"SET","OUTPUT SAFETY \1A20 ON,OFF,&>","Set(_SET_OUTPUTSAFETY,\1A30 )",&sC___273 };
   static COMMANDS sC___275 = {0,"SET","BACKGROUND TASKS \1A20 ON,OFF,&>","Set(_SET_BACKGROUNDTASKS,\1A30 )",&sC___274 };
   static COMMANDS sC___276 = {0,"SET","GTMODE TO \1A30","Set( _SET_GTMODE,\1A30 )",&sC___275 };
   static COMMANDS sC___277 = {0,"SET","BACKGROUNDTICK \1A00","Set( _SET_BACKGROUNDTICK, \1A00 )",&sC___276 };
   static COMMANDS sC___278 = {0,"SET","HARDCOMMIT \1A20 ON,OFF,&>","Set(_SET_HARDCOMMIT,\1A30 )",&sC___277 };
   static COMMANDS sC___279 = {0,"SET","HARDCOMMIT (\1A00)","Set(_SET_HARDCOMMIT,\1A00 )",&sC___278 };
   static COMMANDS sC___280 = {0,"SET","FORCE OPTIMIZATION \1A20 ON,OFF,&>","Set(_SET_FORCEOPT,\1A30 )",&sC___279 };
   static COMMANDS sC___281 = {0,"SET","EOL \1A00","Set( _SET_EOL, \1A00 )",&sC___280 };
#endif
...
#if defined( HB_COMPAT_C53 )
   hb_pp_topCommand = &sC___281;
#else
   hb_pp_topCommand = &sC___257;
#endif
