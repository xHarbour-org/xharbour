...
static HB_CODEPAGE s_codepage = { "UAKOI8",
    ...
    "áâ÷çäå³´öúé¶·êëìíîïðòóôõæèãþûýÿùøüàñ","ÁÂ×ÇÄÅ£¤ÖÚÉ¦§ÊËÌÍÎÏÐÒÓÔÕÆÈÃÞÛÝßÙØÜÀÑ",
    0,0,0,0,NULL,NULL,NULL,NULL,0,NULL };

HB_CODEPAGE_ANNOUNCE( UAKOI8 );

HB_CALL_ON_STARTUP_BEGIN( hb_codepage_Init_UAKOI8 )
   hb_cdpRegister( &s_codepage );
HB_CALL_ON_STARTUP_END( hb_codepage_Init_UAKOI8 )
