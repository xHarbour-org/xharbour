/*
 * $Id: hbmake.prg,v 1.134 2004/12/10 00:00:00 modalsist Exp $
 */
/*
...
*/
   ...
   IF nOption != 1
      pickarry( 11, 15, 20, 64, aIn, aOut ,ArrayAJoin( { oMake:aPrgs, oMake:aCs } ), .T., s_cMsg )
   ELSE
      pickarry( 11, 15, 20, 64, aIn, aOut, {}, .T., s_cMsg )
   ENDIF
