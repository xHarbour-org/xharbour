/*
 * $Id: hbapifs.h,v 1.48 2007/12/19 13:15:22 lculik Exp $
 */
...
extern BYTE     HB_EXPORT * hb_fsCurDirEx   ( USHORT uiDrive ); /* retrieve a static pointer containing current directory for specified drive */
