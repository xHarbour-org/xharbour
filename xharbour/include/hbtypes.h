/*
 * $Id: hbtypes.h,v 1.5 2006/05/16 22:57:08 druzus Exp $
 */
...
typedef PSYMBOLS ( * VM_PROCESS_DLL_SYMBOLS ) ( PHB_SYMB pModuleSymbols, ... );
typedef void ( * VM_DLL_EXECUTE ) ( const BYTE * pCode, PHB_SYMB pSymbols, PHB_ITEM **pGlobals );
