/*
 * $Id: hbapi.h,v 1.224 2007/12/08 02:31:17 ronpinkas Exp $
 */
...
#define HB_VAR_PARAM_NOERR     0xFFFD
   ...
   #include "thread.h"
    ...
    extern HB_EXPORT void   hb_retdts( char * szDateTime );  /* returns a date, must use yyyymmdd hh:mm:ss.cc format */
