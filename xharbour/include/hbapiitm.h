...
extern HB_LONG   HB_EXPORT hb_itemGetNInt      ( PHB_ITEM pItem );
...
extern PHB_ITEM  HB_EXPORT hb_itemPutNInt      ( PHB_ITEM pItem, HB_LONG lNumber );
...
extern PHB_ITEM  HB_EXPORT hb_itemPutNIntLen   ( PHB_ITEM pItem, HB_LONG lNumber, int iWidth );
