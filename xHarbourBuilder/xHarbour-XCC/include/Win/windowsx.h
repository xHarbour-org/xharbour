...
#define Button_GetImage(hwndCtl,type) ((HANDLE)(DWORD)SendMessage((hwndCtl),BM_GETIMAGE,(WPARAM)(int)(type),0))
...
#define Button_SetImage(hwndCtl,type,hImage) ((HANDLE)(DWORD)SendMessage((hwndCtl),BM_SETIMAGE,(WPARAM)(int)(type),(LPARAM)(HANDLE)(hImage)))
...
#define Static_GetIcon(hwndCtl) ((HICON)(DWORD)SendMessage((hwndCtl),STM_GETICON,0,0))
#define Static_GetImage(hwndCtl,type) ((HANDLE)(DWORD)SendMessage((hwndCtl),STM_GETIMAGE,(WPARAM)(int)(type),0))
#define Static_GetText(hwndCtl,lpch,cchMax) GetWindowText((hwndCtl),(lpch),(cchMax))
#define Static_GetTextLength(hwndCtl) GetWindowTextLength(hwndCtl)
#define Static_SetIcon(hwndCtl,hIcon) ((HICON)(DWORD)SendMessage((hwndCtl),STM_SETICON,(WPARAM)(HICON)(hIcon),0))
#define Static_SetImage(hwndCtl,type,hImage) ((HANDLE)(DWORD)SendMessage((hwndCtl),STM_SETIMAGE,(WPARAM)(int)(type),(LPARAM)(HANDLE)(hImage)))
...
#define FORWARD_WM_GETICON(hwnd,fType,fn) (HICON)(DWORD)(fn)((hwnd),WM_GETICON,(WPARAM)(BOOL)(fType),0)
...
#define FORWARD_WM_SETICON(hwnd,fType,hIcon,fn) (HICON)(DWORD)(fn)((hwnd),WM_SETICON,(WPARAM)(BOOL)(fType),(LPARAM)(HICON)(hIcon))
...
#define HANDLE_WM_CONTEXTMENU(hwnd,wParam,lParam,fn) ((fn)((hwnd),(HWND)(wParam),(UINT)LOWORD(lParam),(UINT)HIWORD(lParam)),0L)
