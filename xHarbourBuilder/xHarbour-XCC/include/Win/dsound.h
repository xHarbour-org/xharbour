...
#if DIRECTSOUND_VERSION >= 0x0800
extern HRESULT WINAPI DirectSoundCreate8(LPCGUID,LPDIRECTSOUND8*,LPUNKNOWN);
extern HRESULT WINAPI DirectSoundCaptureCreate8(LPCGUID,LPDIRECTSOUNDCAPTURE8*,LPUNKNOWN);
extern HRESULT WINAPI DirectSoundFullDuplexCreate(LPCGUID,LPCGUID,LPCDSCBUFFERDESC,LPCDSBUFFERDESC,HWND,DWORD,LPDIRECTSOUNDFULLDUPLEX*,LPDIRECTSOUNDCAPTUREBUFFER8*,LPDIRECTSOUNDBUFFER8*,LPUNKNOWN);
#define DirectSoundFullDuplexCreate8 DirectSoundFullDuplexCreate
extern HRESULT WINAPI GetDeviceID(LPCGUID,LPGUID);
#endif /* DIRECTSOUND_VERSION >= 0x0800 */
...
DECLARE_INTERFACE_(IReferenceClock,IUnknown)
{
    ...
    STDMETHOD(AdviseTime)(THIS_ REFERENCE_TIME,REFERENCE_TIME,HANDLE,LPDWORD) PURE;
    STDMETHOD(AdvisePeriodic)(THIS_ REFERENCE_TIME,REFERENCE_TIME,HANDLE,LPDWORD) PURE;
...
DECLARE_INTERFACE_(IDirectSoundCaptureBuffer8,IDirectSoundCaptureBuffer)
{
    ...
    STDMETHOD(Unlock)(THIS_ LPVOID,DWORD,LPVOID,DWORD) PURE;
    STDMETHOD(GetObjectInPath)(THIS_ REFGUID,DWORD,REFGUID,LPVOID*) PURE;
    STDMETHOD(GetFXStatus)(DWORD,LPDWORD) PURE;
};
