...
//#define _DLL_NAME_ "XBScriptEnt.dll"
//#define _DLL_NAME_ "XBScriptPro.dll"
#define _DLL_NAME_ "XBScript.dll"
...
STDAPI DllRegisterServer(void)
{
   ...
   char szFileName[255] ;//= "XBScript";
   HMODULE dllModule = GetModuleHandle( _DLL_NAME_ );
...
{
   OutputDebugValues( NULL, "DllGetClassObject(%p)\n", rclsid );
   ...
   if( IsEqualCLSID(rclsid, CLSID_XBScript ) )
   {
	  ...
	  {
         s_bInit = FALSE;
		 OutputDebugValues( NULL, "Init VM...\n" );
		 hb_vmInit( FALSE );
		 OutputDebugValues( NULL, "Done.\n" );
	  }
#endif
   ...
   {
	  OutputDebugValues( NULL, "!!! WRONG Class ID!!!\n" );
      return E_FAIL;
   }
...
STDAPI DllCanUnloadNow()
{
	...
	{
		#ifndef VM_RESET
		   OutputDebugValues( NULL, "(%i)Quiting VM...\n", g_cLock );
		   hb_vmQuit();
		   OutputDebugValues( NULL, "Done\n" );
		#endif
