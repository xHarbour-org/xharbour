Procedure Main( sMsg )
   ...
   TRY
      //PP_Run( "Test_PRG_Script.prg", { "Recursively running self" } )
      xResult := oInterpreter:RunFile( "Test_PRG_Script.prg", { "Recursively running self" }, ".pp", .F. ) // Output PreProcessed extension .pp wirhout blanks.
