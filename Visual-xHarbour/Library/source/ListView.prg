...
CLASS ListView INHERIT Control
   ...
   PROPERTY AutoArrange    INDEX LVS_AUTOARRANGE      READ xAutoArrange    WRITE SetStyle     DEFAULT .T. PROTECTED
   ...
   DATA View_Styles EXPORTED  INIT { "Icon", "Report", "SmallIcon", "List" }
...
METHOD Init( oParent ) CLASS ListView
   ...
   ::Style        := WS_CHILD | WS_VISIBLE | LVS_AUTOARRANGE | WS_CLIPCHILDREN | WS_CLIPSIBLINGS
